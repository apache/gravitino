...
import static com.datastrato.graviton.catalog.hive.HiveCatalog.isValidateNamespace;
...
public class HiveDatabase implements Entity {
  ...
  private Database generateInnerDatabase() {
  ...
  public static class Builder {
    ...
    public HiveDatabase build() {
      if (null == this.hiveDatabase.innerDatabase) {
        this.hiveDatabase.innerDatabase = hiveDatabase.generateInnerDatabase();
      }
      return hiveDatabase;
    }
  }
