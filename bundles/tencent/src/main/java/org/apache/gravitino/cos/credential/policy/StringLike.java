...
/**
 * Tencent Cloud CAM {@code string_like} condition value. The {@code cos:prefix} key is used to
 * restrict {@code cos:GetBucket}/{@code ListObjects} to a specific prefix inside the bucket.
 */
