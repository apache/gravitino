...
public class TestAzureFileSystemProvider {
  ...
  public void testContainsClientCredentialsTrueWhenBothKeysPresent() {
    Assertions.assertTrue(
        provider.containsClientCredentials(
            ImmutableMap.of(
                AzureProperties.GRAVITINO_AZURE_STORAGE_ACCOUNT_NAME, "name",
                AzureProperties.GRAVITINO_AZURE_STORAGE_ACCOUNT_KEY, "key")));
  }
  ...
  public void testContainsClientCredentialsFalseWhenIncomplete() {
    Assertions.assertFalse(
        provider.containsClientCredentials(
            ImmutableMap.of(AzureProperties.GRAVITINO_AZURE_STORAGE_ACCOUNT_NAME, "name")));
  }
}
