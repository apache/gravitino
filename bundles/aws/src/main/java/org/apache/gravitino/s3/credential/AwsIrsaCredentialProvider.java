...
public class AwsIrsaCredentialProvider implements CredentialProvider {
    ...
    public Credential getCredential(CredentialContext context) {
        ...
        if (creds instanceof AwsSessionCredentials) {
            ...
            long expiration = sessionCreds.expirationTime().isPresent() ?
                sessionCreds.expirationTime().get().toEpochMilli() : 0L;
            ...
            throw new IllegalStateException(
                ...
                "Check your EKS/IRSA configuration. Got: " + creds.getClass().getName()
            );
        }
    }
} 