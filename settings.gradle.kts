...
include(":bundles:aws-bundle", ":bundles:aws-hadoop-bundle")
include(":bundles:gcp-bundle", ":bundles:gcp-hadoop-bundle")
include(":bundles:aliyun-bundle", ":bundles:aliyun-hadoop-bundle")
include(":bundles:azure-bundle", ":bundles:azure-hadoop-bundle")
