...
include("authorizations:authorization-ranger", "authorizations:authorization-jdbc")
...
include(":bundles:aws-core")
include(":bundles:aws-bundle")
include(":bundles:gcp-core")
include(":bundles:gcp-bundle")
include(":bundles:aliyun-core")
include(":bundles:aliyun-bundle")
include(":bundles:azure-core")
