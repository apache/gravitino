 ...
 * under the License.
 */
package org.apache.gravitino.spark.connector.jdbc.postgersql;
...
public class PostgreSqlPropertiesConverter implements PropertiesConverter {

  public static class PostgresPropertiesConverterHolder {
    private static final PostgreSqlPropertiesConverter INSTANCE =
        new PostgreSqlPropertiesConverter();
  }

  private PostgreSqlPropertiesConverter() {}

  public static PostgreSqlPropertiesConverter getInstance() {
    return PostgreSqlPropertiesConverter.PostgresPropertiesConverterHolder.INSTANCE;
  }
