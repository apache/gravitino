...
import org.apache.gravitino.spark.connector.glue.GravitinoGlueCatalogSpark34;
...
/**
 * Integration test for Spark 3.4 Glue catalog connector. Starts LocalStack to mock AWS Glue API and
 * S3 storage.
 */
public class SparkGlueCatalogIT34 extends SparkGlueCatalogIT {
  ...
  void testCatalogClassName() {
    ...
    Assertions.assertEquals(GravitinoGlueCatalogSpark34.class.getName(), catalogClass);
  }
}
