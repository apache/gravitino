...
public class TestSparkTableChangeConverter34 {
  ...
  void testUpdateColumnDefaultValue() {
    ...
    Assertions.assertTrue(
        gravitinoChange instanceof com.apache.gravitino.rel.TableChange.UpdateColumnDefaultValue);
    com.apache.gravitino.rel.TableChange.UpdateColumnDefaultValue
        gravitinoUpdateColumnDefaultValue =
            (com.apache.gravitino.rel.TableChange.UpdateColumnDefaultValue) gravitinoChange;
