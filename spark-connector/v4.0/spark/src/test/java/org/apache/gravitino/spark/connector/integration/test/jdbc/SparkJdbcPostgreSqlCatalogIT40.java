...
public class SparkJdbcPostgreSqlCatalogIT40 extends SparkJdbcPostgreSqlCatalogIT {
  @Test
  void testCatalogClassName() {
    ...
    Assertions.assertEquals(GravitinoPostgreSqlCatalogSpark40.class.getName(), catalogClass);
  }
}
