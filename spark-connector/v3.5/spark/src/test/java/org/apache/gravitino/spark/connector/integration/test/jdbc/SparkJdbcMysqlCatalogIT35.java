...
public class SparkJdbcMysqlCatalogIT35 extends SparkJdbcPostgreSqlCatalogIT {
  @Test
  void testCatalogClassName() {
    ...
    Assertions.assertEquals(GravitinoJdbcCatalogSpark35.class.getName(), catalogClass);
  }
}
