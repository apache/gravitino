...
/** Doris-specific logical-to-Catalyst type mappings for Spark 3.5. */
final class DorisSparkTypeConverter35 extends SparkJdbcTypeConverter {
  ...
  public DataType toSparkType(Type gravitinoType) {
    if (gravitinoType instanceof Types.FixedCharType
        ...
        || gravitinoType instanceof Types.ExternalType) {
