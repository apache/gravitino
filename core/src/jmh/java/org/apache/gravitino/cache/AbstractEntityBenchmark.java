 ...
 *
 * <p>This class sets up a controlled environment where a configurable number of entities are
 * preloaded into the cache before each iteration. It supports benchmarking cache operations such as
 * put, get, contains, and invalidate under varying data volumes.
 *
 * <p>Features:
 *
 * <ul>
...
@State(Scope.Thread)
public abstract class AbstractEntityBenchmark {
  @Param({"10", "100", "1000"})
  public int totalCnt;
