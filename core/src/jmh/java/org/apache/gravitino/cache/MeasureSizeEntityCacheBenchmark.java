 ...
 *
 * <p>During setup, entities are preloaded into the cache using the configured entity count. This
 * ensures that the {@code size()} method operates on a fully populated cache with realistic
 ...
 */
public class MeasureSizeEntityCacheBenchmark extends AbstractEntityBenchmark {
