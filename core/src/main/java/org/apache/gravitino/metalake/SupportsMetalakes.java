...
public interface SupportsMetalakes {
   ...
   *       thrown.
   *   <li>The method {@link #deactivateMetalake(NameIdentifier)} has been called before dropping
   ...
   * @throws NoSuchMetalakeException If the metalake does not exist.
   */
  void deactivateMetalake(NameIdentifier ident) throws NoSuchMetalakeException;
}
