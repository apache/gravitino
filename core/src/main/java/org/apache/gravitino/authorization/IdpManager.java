...
public interface IdpManager {
   ...
   */
  IdpUserDTO createUser(String userName, String password);
   ...
   */
  IdpUserDTO getUser(String userName);
   ...
   */
  IdpUserDTO resetPassword(String userName, String password);
   ...
   */
  IdpGroupDTO createGroup(String groupName);
   ...
   */
  IdpGroupDTO getGroup(String groupName);
   ...
   */
  IdpGroupDTO addUsersToGroup(String groupName, List<String> userNames);
