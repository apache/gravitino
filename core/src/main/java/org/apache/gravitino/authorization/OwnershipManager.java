...
public class OwnershipManager {
  ...
  public void setOwner(
      NameIdentifier identifier, Entity.EntityType type, String ownerName, String ownerType) {
    try {
      String metalake;
      ...
      if (ownerType.equals(Owner.Type.USER.name())) {
        store
            .relationOperations()
            .insertRelation(
                ...
                true);
      } else if (ownerType.equals(Owner.Type.GROUP.name())) {
        store
            .relationOperations()
            .insertRelation(
                Relation.Type.OWNER_REL,
