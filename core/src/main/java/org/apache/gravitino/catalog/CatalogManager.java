        ...
        Caffeine.newBuilder()
            ...
            .removalListener(
                (k, v, c) -> {
                  ...
                  // Retire rather than close: an operation that already leased this wrapper keeps
                  // it alive, and the actual catalog/ClassLoader cleanup runs when the last lease
                  // is released.
