...
public class SchemaOperationDispatcher extends OperationDispatcher implements SchemaDispatcher {
  ...
  public Schema createSchema(NameIdentifier ident, String comment, Map<String, String> properties)
    ...
    // Catalog-level tree lock is held in SchemaHookDispatcher#createSchema so post-hooks
    // (e.g. ownership) run under the same critical section as the underlying create.
