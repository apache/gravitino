...
public class OwnerMetaSQLProvider {

  private static final Map<JDBCBackendType, OwnerMetaBaseProvider> METALAKE_META_SQL_PROVIDER_MAP =
      ImmutableMap.of(
  ...
  static class OwnerMetaMySQLProvider extends OwnerMetaBaseProvider {}
