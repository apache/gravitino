...
public interface OwnerMetaMapper {
  ...
  @SelectProvider(type = OwnerMetaSQLProviderFactory.class, method = "selectAllOwner")
  List<OwnerRelPO> selectAllOwner(@Param("skipNum") Long skipNum, @Param("fetchNum") Long fetchNum);

  @SelectProvider(type = OwnerMetaSQLProviderFactory.class, method = "countAllOwner")
  long countAllOwner();
