...
public class MetadataObjectService {
  ...
  @Monitored(prefix = GRAVITINO_RELATIONAL_STORE_METRIC_NAME + ".fromGenericEntities")
  ...
  @Monitored(prefix = GRAVITINO_RELATIONAL_STORE_METRIC_NAME + ".getMetadataObjectId")
   ...
   */
  @Monitored(prefix = GRAVITINO_RELATIONAL_STORE_METRIC_NAME + ".getMetalakeObjectsFullName")
   ...
   */
  @Monitored(prefix = GRAVITINO_RELATIONAL_STORE_METRIC_NAME + ".getFilesetObjectsFullName")
   ...
   */
  @Monitored(prefix = GRAVITINO_RELATIONAL_STORE_METRIC_NAME + ".getModelObjectsFullName")
   ...
   */
  @Monitored(prefix = GRAVITINO_RELATIONAL_STORE_METRIC_NAME + ".getTableObjectsFullName")
   ...
   */
  @Monitored(prefix = GRAVITINO_RELATIONAL_STORE_METRIC_NAME + ".getColumnObjectsFullName")
   ...
   */
  @Monitored(prefix = GRAVITINO_RELATIONAL_STORE_METRIC_NAME + ".getTopicObjectsFullName")
   ...
   *     name: "catalog1"
   */
  @Monitored(prefix = GRAVITINO_RELATIONAL_STORE_METRIC_NAME + ".getCatalogObjectsFullName")
   ...
   *     "catalog1.schema1"
   */
  @Monitored(prefix = GRAVITINO_RELATIONAL_STORE_METRIC_NAME + ".getSchemaObjectsFullName")
