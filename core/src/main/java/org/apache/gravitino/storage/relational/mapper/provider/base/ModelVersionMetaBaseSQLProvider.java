...
public class ModelVersionMetaBaseSQLProvider {
  ...
  //  public String softDeleteModelVersionMetasByModelId(@Param("modelId") Long modelId) {
  //    return "UPDATE "
  //        + ModelVersionMetaMapper.TABLE_NAME
  //        + " SET deleted_at = (UNIX_TIMESTAMP() * 1000.0)"
  //        + " + EXTRACT(MICROSECOND FROM CURRENT_TIMESTAMP(3)) / 1000"
  ...
  //  public String softDeleteModelVersionAliasRelByModelId(@Param("modelId") Long modelId) {
  //    return "UPDATE "
  //        + ModelVersionMetaMapper.MODEL_VERSION_ALIAS_REL_TABLE
  //        + " SET deleted_at = (UNIX_TIMESTAMP() * 1000.0)"
  //        + " + EXTRACT(MICROSECOND FROM CURRENT_TIMESTAMP(3)) / 1000"
  //        + " WHERE model_id = #{modelId} AND deleted_at = 0";
  //  }
  ...
  //  }
  //
  //  public String softDeleteModelVersionMetasByModelIdAndAlias(
  //      @Param("modelId") Long modelId, @Param("alias") String alias) {
  //    return "UPDATE "
  //        + ModelVersionMetaMapper.MODEL_VERSION_INFO_TABLE
  //        + " SET deleted_at = (UNIX_TIMESTAMP() * 1000.0)"
  //        + " + EXTRACT(MICROSECOND FROM CURRENT_TIMESTAMP(3)) / 1000"
  //        + " WHERE model_id = #{modelId} AND version = ("
  //        + " SELECT model_version FROM "
