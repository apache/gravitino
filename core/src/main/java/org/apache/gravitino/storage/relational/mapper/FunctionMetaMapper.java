...
public interface FunctionMetaMapper {
  ...
  @SelectProvider(
      type = FunctionMetaSQLProviderFactory.class,
      method = "selectFunctionMetaWithVersionBySchemaIdAndNameAndVersion")
  FunctionPO selectFunctionMetaWithVersionBySchemaIdAndNameAndVersion(
  ...
  @UpdateProvider(
      type = FunctionMetaSQLProviderFactory.class,
      method = "softDeleteFunctionMetaBySchemaIdAndFunctionName")
  Integer softDeleteFunctionMetaBySchemaIdAndFunctionName(
      @Param("schemaId") Long schemaId, @Param("functionName") String functionName);
