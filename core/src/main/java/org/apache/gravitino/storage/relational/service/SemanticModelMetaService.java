...
public class SemanticModelMetaService {
   ...
   * @param overwrite Whether to overwrite a row with the same stable ID.
  ...
  private SemanticModelPO updateSemanticModelPO(
    ...
    Long newVersion = oldSemanticModelPO.getLastVersion() + 1;
    ...
    return buildSemanticModelPO(newEntity, builder, newVersion.intValue());
  }
