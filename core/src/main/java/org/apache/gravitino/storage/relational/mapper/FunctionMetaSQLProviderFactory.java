...
public class FunctionMetaSQLProviderFactory {
  ...
  public static String selectFunctionMetaWithVersionBySchemaIdAndNameAndVersion(
      @Param("schemaId") Long schemaId,
      @Param("functionName") String functionName,
      @Param("version") Integer version) {
    return getProvider()
        .selectFunctionMetaWithVersionBySchemaIdAndNameAndVersion(schemaId, functionName, version);
  }
  ...
  public static String softDeleteFunctionMetaBySchemaIdAndFunctionName(
      @Param("schemaId") Long schemaId, @Param("functionName") String functionName) {
    return getProvider().softDeleteFunctionMetaBySchemaIdAndFunctionName(schemaId, functionName);
  }
