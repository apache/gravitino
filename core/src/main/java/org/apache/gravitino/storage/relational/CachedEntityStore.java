...
public class CachedEntityStore
  ...
  public CachedEntityStore(EntityStore entityStore, EntityCache cache) {
    Preconditions.checkArgument(
        ...
        "CachedEntityStore requires a RelationalEntityStore instance.");
  ...
  public <E extends Entity & HasIdentifier> List<E> listEntitiesByRelation(
    ...
    return cache.getOrLoad(nameIdentifier, identType, relType, true);
  }
  ...
  public <E extends Entity & HasIdentifier> List<E> listEntitiesByRelation(
      ...
      throws IOException {
    return cache.getOrLoad(nameIdentifier, identType, relType, allFields);
  }
