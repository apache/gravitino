...
public class RoleMetaSQLProviderFactory {
  ...
  public static String listExtendedRolePOsByMetalake(@Param("metalakeName") String metalakeName) {
    return getProvider().listExtendedRolePOsByMetalake(metalakeName);
  }
