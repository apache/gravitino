...
public interface JobOperationDispatcher extends Closeable {
   ...
   * stdout/stderr output (see {@link JobEntity#stdout()}/{@link JobEntity#stderr()}).
   *
   ...
   */
  JobEntity getJob(String metalake, String jobId, boolean includeOutput) throws NoSuchJobException;
