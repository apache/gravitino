...
/**
 * Optional extension for entity stores that support lookup and mutation by Gravitino-assigned id
 * within a metalake.
 */
public interface SupportsIdOperations {
   ...
   */
  boolean deleteById(NameIdentifier ident, Entity.EntityType entityType) throws IOException;
}
