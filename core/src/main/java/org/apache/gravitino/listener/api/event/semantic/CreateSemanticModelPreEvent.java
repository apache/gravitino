...
public class CreateSemanticModelPreEvent extends SemanticModelPreEvent {
  ...
  /**
   * Constructs an instance of {@code CreateSemanticModelPreEvent}.
   *
   ...
   */
  public CreateSemanticModelPreEvent(
      String user, NameIdentifier identifier, SemanticModelInfo createSemanticModelRequest) {
