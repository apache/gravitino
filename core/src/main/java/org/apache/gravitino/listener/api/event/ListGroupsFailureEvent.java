...
/**
 * Represents an event triggered when an attempt to list groups from a metalake fails due to an
 * exception.
 */
@DeveloperApi
public class ListGroupsFailureEvent extends GroupFailureEvent {

  /**
   * Creates a new instance of {@code ListGroupsFailureEvent}.
   *
   ...
   */
  public ListGroupsFailureEvent(String initiator, String metalake, Exception exception) {
