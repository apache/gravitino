...
/** Represents an event triggered before setting a policy on a tag. */
@DeveloperApi
public final class SetPolicyForTagPreEvent extends TagPreEvent {
  ...
  /**
   * Constructs an event triggered before setting a policy on a tag.
   *
   ...
   */
  public SetPolicyForTagPreEvent(
      String user,
      String metalake,
      String tagName,
      String policyName,
