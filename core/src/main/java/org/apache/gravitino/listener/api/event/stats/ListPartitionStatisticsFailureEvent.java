...
@DeveloperApi
public class ListPartitionStatisticsFailureEvent extends StatisticsFailureEvent {
   ...
   * @param partitionRange the partition range for which statistics were being listed
   */
  public ListPartitionStatisticsFailureEvent(
      String user, NameIdentifier identifier, Exception exception, PartitionRange partitionRange) {
