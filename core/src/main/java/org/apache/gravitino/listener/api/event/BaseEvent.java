...
public abstract class BaseEvent {
  ...
  /**
   * Accept a dispatcher to process the event.
   *
   * @param dispatcher the implementation of the visitor interface.
   */
  public abstract void accept(EventDispatcher dispatcher);
