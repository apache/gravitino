...
/** Represents an event triggered when retrieving a user by Gravitino-assigned id fails. */
@DeveloperApi
public class GetUserByIdFailureEvent extends UserFailureEvent {
  private final long userId;

  /**
   * Creates a new {@link GetUserByIdFailureEvent}.
   *
   ...
   */
  public GetUserByIdFailureEvent(
