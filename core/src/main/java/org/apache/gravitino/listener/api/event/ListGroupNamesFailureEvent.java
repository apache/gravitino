...
/**
 * Represents an event triggered when an attempt to list group names from a metalake fails due to an
 * exception.
 */
@DeveloperApi
public class ListGroupNamesFailureEvent extends GroupFailureEvent {

  /**
   * Creates a new instance of {@code ListGroupNamesFailureEvent}.
   *
   ...
   */
  public ListGroupNamesFailureEvent(String initiator, String metalake, Exception exception) {
