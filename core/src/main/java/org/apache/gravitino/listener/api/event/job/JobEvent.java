...
/**
 * Represents an abstract base class for events related to job operations. This class extends {@link
 * Event} to provide a more specific context involving operations on jobs, such as get, run, or
 * cancel.
 */
@DeveloperApi
public abstract class JobEvent extends Event {
  ...
  /**
   * Constructs a new {@code JobEvent} with the specified user and job identifier.
   *
