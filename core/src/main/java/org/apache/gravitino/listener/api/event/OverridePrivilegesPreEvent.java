...
/**
 * Represents an event generated before overriding privileges in a role. This class encapsulates the
...
public class OverridePrivilegesPreEvent extends RolePreEvent {
  ...
  /**
   * Constructs a new {@link OverridePrivilegesPreEvent} instance with the specified initiator,
   ...
   * @param securableObjectsToOverride The list of securable objects to override in the role.
   */
