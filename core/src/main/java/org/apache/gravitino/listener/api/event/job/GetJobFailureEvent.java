...
public class GetJobFailureEvent extends JobFailureEvent {
   ...
   * @param exception The exception encountered during the job retrieval, providing insights into
   *     the reasons behind the failure.
   */
  public GetJobFailureEvent(String user, String metalake, String jobId, Exception exception) {
