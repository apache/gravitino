...
/** Represents an event triggered before removing a group by Gravitino-assigned id. */
@DeveloperApi
public class RemoveGroupByIdPreEvent extends GroupPreEvent {
   ...
   */
  public RemoveGroupByIdPreEvent(String initiator, String metalake, long groupId) {
