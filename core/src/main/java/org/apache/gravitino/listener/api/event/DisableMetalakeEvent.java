...
/** Represents an event that is triggered upon successfully disabling a metalake. */
@DeveloperApi
public final class DisableMetalakeEvent extends MetalakeEvent {
   ...
   *
   * @param user The username of the individual who initiated the metalake disabling operation.
