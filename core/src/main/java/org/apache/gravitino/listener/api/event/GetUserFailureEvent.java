...
/**
 * Represents an event triggered when an attempt to retrieve a user from the metalake fails due to
 * an exception.
 */
@DeveloperApi
public class GetUserFailureEvent extends UserFailureEvent {
   ...
   */
  public GetUserFailureEvent(String user, String metalake, Exception exception, String userName) {
