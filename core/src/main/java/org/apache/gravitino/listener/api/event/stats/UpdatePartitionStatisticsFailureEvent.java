...
@DeveloperApi
public class UpdatePartitionStatisticsFailureEvent extends StatisticsFailureEvent {
   ...
   * @param partitionStatisticsUpdates the partition statistics updates that were being applied
   */
