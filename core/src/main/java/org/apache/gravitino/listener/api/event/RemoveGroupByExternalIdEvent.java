...
/** Represents an event triggered after removing a group by external id. */
@DeveloperApi
public class RemoveGroupByExternalIdEvent extends GroupEvent {
  private final String externalId;
  private final boolean isExists;

  public RemoveGroupByExternalIdEvent(
  ...
  /** Returns the external identifier of the removed group. */
