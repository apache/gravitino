...
/** Represents an event triggered when setting a policy on a tag fails. */
@DeveloperApi
public final class SetPolicyForTagFailureEvent extends TagFailureEvent {
  ...
  /**
   * Constructs an event triggered when setting a policy on a tag fails.
   *
   ...
   */
  public SetPolicyForTagFailureEvent(
      String user,
      String metalake,
      String tagName,
      String policyName,
