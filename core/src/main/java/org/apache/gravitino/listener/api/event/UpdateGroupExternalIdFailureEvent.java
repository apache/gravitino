...
/** Represents an event triggered when updating a group external id fails. */
@DeveloperApi
public class UpdateGroupExternalIdFailureEvent extends GroupFailureEvent {
  private final long groupId;
  private final String newExternalId;

  /**
   * Creates a new {@link UpdateGroupExternalIdFailureEvent}.
   *
   ...
   */
  public UpdateGroupExternalIdFailureEvent(
      String initiator, String metalake, Exception exception, long groupId, String newExternalId) {
