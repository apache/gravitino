...
public class GetRoleEvent extends RoleEvent {
   ...
   */
  public GetRoleEvent(String initiator, String metalake, RoleInfo loadedRoleInfo) {
    super(initiator, NameIdentifierUtil.ofRole(metalake, loadedRoleInfo.roleName()));
