...
/** Represents an event that is triggered upon successfully enabling a metalake. */
@DeveloperApi
public final class EnableMetalakeEvent extends MetalakeEvent {
   ...
   *
   * @param user The username of the individual who initiated the metalake enabling operation.
