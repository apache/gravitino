...
public class ListModelFailureEvent extends ModelFailureEvent {
   ...
   *
   * @param user The username of the individual who initiated the operation to list models.
   ...
   *
   * @return A {@link Namespace} instance for which the model listing was attempted
   */
