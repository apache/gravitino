...
/** Failure event for dropping a Semantic Model. */
@DeveloperApi
public final class DropSemanticModelFailureEvent extends SemanticModelFailureEvent {

  /**
   * Constructs an instance of {@code DropSemanticModelFailureEvent}.
   *
   ...
   */
  public DropSemanticModelFailureEvent(
