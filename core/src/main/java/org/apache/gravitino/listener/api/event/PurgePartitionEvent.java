...
/** Represents an event that occurs after a partition is successfully purged from the table. */
@DeveloperApi
public final class PurgePartitionEvent extends PartitionEvent {
   ...
   * @param identifier The identifier of the partition that was targeted for purging.
  ...
  /**
   * Retrieves the status of the partition's existence at the time of the purge operation.
   *
