...
/** Represents an event triggered when retrieving a user by external id fails. */
@DeveloperApi
public class GetUserByExternalIdFailureEvent extends UserFailureEvent {
  private final String externalId;

  /**
   * Creates a new {@link GetUserByExternalIdFailureEvent}.
   *
   ...
   */
  public GetUserByExternalIdFailureEvent(
