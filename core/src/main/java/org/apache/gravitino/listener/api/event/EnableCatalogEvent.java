...
/** Represents an event that is triggered upon successfully enabling a catalog. */
@DeveloperApi
public final class EnableCatalogEvent extends CatalogEvent {
   ...
   *
   * @param user The username of the individual who initiated the catalog enabling operation.
