...
public class ListSemanticModelPreEvent extends SemanticModelPreEvent {
  ...
  /**
   * Constructs an instance of {@code ListSemanticModelPreEvent}.
   *
   * @param user The username of the individual who initiated the Semantic Model listing.
   * @param namespace The namespace from which Semantic Models are listed.
   */
  public ListSemanticModelPreEvent(String user, Namespace namespace) {
