...
public class UserInfo {
  ...
  /**
   * Create a new {@link UserInfo} instance with the given {@link User} information.
   *
  ...
  /**
   * Create a new {@link UserInfo} instance with the given name and no roles. the roles set to
   * {@code Optional.empty()}.
   *
  ...
  /**
   * Create a new {@link UserInfo} instance with the given name and roles.
   *
   * @param name the name of the user.
