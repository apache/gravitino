...
/** Represents an event that is triggered when an attempt to test a catalog connection fails. */
@DeveloperApi
public final class TestConnectionFailureEvent extends CatalogFailureEvent {
   ...
   *
   * @param user The username of the individual who initiated the test connection operation.
   * @param identifier The identifier of the catalog whose connection test failed.
   * @param exception The exception that was encountered during the test connection attempt.
   */
  ...
  public OperationType operationType() {
    return OperationType.TEST_CONNECTION;
  }
}
