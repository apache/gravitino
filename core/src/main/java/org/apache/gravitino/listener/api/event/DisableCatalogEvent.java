...
/** Represents an event that is triggered upon successfully disabling a catalog. */
@DeveloperApi
public final class DisableCatalogEvent extends CatalogEvent {
   ...
   *
   * @param user The username of the individual who initiated the catalog disabling operation.
