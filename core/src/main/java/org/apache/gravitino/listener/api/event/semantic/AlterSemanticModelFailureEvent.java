...
/** Failure event for altering a Semantic Model. */
@DeveloperApi
public final class AlterSemanticModelFailureEvent extends SemanticModelFailureEvent {
  private final SemanticModelChange[] semanticModelChanges;

  /**
   * Constructs an instance of {@code AlterSemanticModelFailureEvent}.
   *
   ...
   * @param semanticModelChanges The changes that failed to apply.
   */
  public AlterSemanticModelFailureEvent(
      String user,
