...
public class CompatibilityUtils {
  ...
  private static final ImmutableMap<OperationType, Operation> OPERATION_TYPE_MAP =
      ImmutableMap.<OperationType, Operation>builder()
          ...
          .put(OperationType.REMOVE_USER_BY_EXTERNAL_ID, Operation.REMOVE_USER_BY_EXTERNAL_ID)
          .put(OperationType.GET_USER, Operation.GET_USER)
          .put(OperationType.GET_BASIC_USER, Operation.GET_BASIC_USER)
          .put(OperationType.GET_USER_BY_EXTERNAL_ID, Operation.GET_USER_BY_EXTERNAL_ID)
          .put(OperationType.GET_USER_BY_ID, Operation.GET_USER_BY_ID)
          .put(OperationType.REMOVE_USER_BY_ID, Operation.REMOVE_USER_BY_ID)
          .put(OperationType.ALTER_USER, Operation.ALTER_USER)
          ...
          .put(OperationType.REMOVE_GROUP_BY_EXTERNAL_ID, Operation.REMOVE_GROUP_BY_EXTERNAL_ID)
          .put(OperationType.GET_GROUP, Operation.GET_GROUP)
          .put(OperationType.GET_BASIC_GROUP, Operation.GET_BASIC_GROUP)
          .put(OperationType.GET_GROUP_BY_EXTERNAL_ID, Operation.GET_GROUP_BY_EXTERNAL_ID)
