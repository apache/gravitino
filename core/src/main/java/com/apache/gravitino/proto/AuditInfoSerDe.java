...
class AuditInfoSerDe implements ProtoSerDe<com.apache.gravitino.meta.AuditInfo, AuditInfo> {

  /**
   * Serializes an {@link com.apache.gravitino.meta.AuditInfo} object to a {@link AuditInfo} object.
   *
   * @param auditInfo The AuditInfo object to be serialized.
   * @return The serialized AuditInfo object.
   */
  @Override
  public AuditInfo serialize(com.apache.gravitino.meta.AuditInfo auditInfo) {
  ...
  /**
   * Deserializes a {@link AuditInfo} object to an {@link com.apache.gravitino.meta.AuditInfo}
   * object.
   *
   ...
   */
  @Override
  public com.apache.gravitino.meta.AuditInfo deserialize(AuditInfo p, Namespace namespace) {
    com.apache.gravitino.meta.AuditInfo.Builder builder =
