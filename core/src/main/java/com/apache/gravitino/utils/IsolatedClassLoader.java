 ...
 * under the License.
 */
package com.apache.gravitino.utils;
...
public class IsolatedClassLoader implements Closeable {
  ...
  private boolean isCatalogClass(String name) {
    return name.startsWith("com.apache.gravitino.catalog")
        && (name.startsWith("com.apache.gravitino.catalog.hive.")
            || name.startsWith("com.apache.gravitino.catalog.lakehouse.")
            || name.startsWith("com.apache.gravitino.catalog.jdbc.")
            || name.startsWith("com.apache.gravitino.catalog.mysql.")
            || name.startsWith("com.apache.gravitino.catalog.postgresql.")
            || name.startsWith("com.apache.gravitino.catalog.doris.")
            || name.startsWith("com.apache.gravitino.catalog.hadoop.")
            || name.startsWith("com.apache.gravitino.catalog.kafka."));
  }
