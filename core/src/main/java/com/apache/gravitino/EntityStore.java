...
public interface EntityStore extends Closeable {
  ...
  /**
   * List all the entities with the specified {@link com.apache.gravitino.Namespace}, and
  ...
  /**
   * Check if the entity with the specified {@link com.apache.gravitino.NameIdentifier} exists.
   *
   ...
   *
   * <p>Note: the {@link com.apache.gravitino.NameIdentifier} of the updated entity may be changed.
   ...
   * com.apache.gravitino.NameIdentifier}.
   *
   * @param ident the name identifier of the entity
