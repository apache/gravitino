...
public class CatalogOperationDispatcher implements TableCatalog, FilesetCatalog, SupportsSchemas {
  ...
  public Table alterTable(NameIdentifier ident, TableChange... changes)
    ...
    LOG.info("yuqiabc: alterTable: ident: {}, changes: {}", ident, changes);
    NameIdentifier catalogIdent = getCatalogIdentifier(ident);
    ...
    LOG.info(
        "yuqiabc: alterTable: ident: {}, tempAlteredTable: {}",
        ident,
        tempAlteredTable.auditInfo());
    // Retrieve the Table again to obtain some values generated by underlying catalog
    Table alteredTable =
        doWithCatalog(
            catalogIdent,
    ...
    LOG.info("yuqiabc: alterTable: ident: {}, alteredTable: {}", ident, alteredTable.auditInfo());
    ...
    LOG.info(
        "yuqiabc: alterTable: ident: {}, updatedTableEntity: {}",
        ident,
        updatedTableEntity == null ? null : updatedTableEntity.auditInfo());
