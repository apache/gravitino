...
public class CatalogOperationDispatcher implements TableCatalog, SupportsSchemas {
  ...
  public Schema createSchema(NameIdentifier ident, String comment, Map<String, String> properties)
    ...
    boolean isManagedSchema = isManagedSchema(createdSchema);
    if (isManagedSchema) {
      return EntityCombinedSchema.of(createdSchema)
          .withHiddenPropertiesSet(
              getHiddenSchemaPropertyNames(catalogIdent, createdSchema.properties()));
    }
  ...
  public Schema loadSchema(NameIdentifier ident) throws NoSuchSchemaException {
    ...
    boolean isManagedSchema = isManagedSchema(schema);
    if (isManagedSchema) {
      return EntityCombinedSchema.of(schema)
          .withHiddenPropertiesSet(
  ...
  public Schema alterSchema(NameIdentifier ident, SchemaChange... changes)
    ...
    boolean isManagedSchema = isManagedSchema(alteredSchema);
    if (isManagedSchema) {
  ...
  private boolean isManagedSchema(Schema schema) {
    return schema
        .properties()
        .getOrDefault(BasePropertiesMetadata.GRAVITINO_MANAGED_ENTITY, Boolean.FALSE.toString())
