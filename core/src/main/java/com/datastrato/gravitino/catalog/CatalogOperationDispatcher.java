...
public class CatalogOperationDispatcher implements TableCatalog, SupportsSchemas {
  ...
  public Schema createSchema(NameIdentifier ident, String comment, Map<String, String> properties)
    ...
    final NameIdentifier uniformIdent = getUniformNameIdentifier(ident);
    NameIdentifier catalogIdent = getCatalogIdentifier(uniformIdent);
    doWithCatalog(
        catalogIdent,
        c ->
    ...
    doWithCatalog(
        catalogIdent,
        c -> c.doWithSchemaOps(s -> s.createSchema(uniformIdent, comment, updatedProperties)),
        NoSuchCatalogException.class,
    ...
    Schema schema =
        doWithCatalog(
            catalogIdent,
            c -> c.doWithSchemaOps(s -> s.loadSchema(uniformIdent)),
            NoSuchSchemaException.class);

    SchemaEntity schemaEntity =
        new SchemaEntity.Builder()
            .withId(uid)
            .withName(uniformIdent.name())
            .withNamespace(uniformIdent.namespace())
            .withAuditInfo(
    ...
    try {
      ...
      LOG.error(FormattedErrorMessages.STORE_OP_FAILURE, "put", uniformIdent, e);
  ...
  public Schema loadSchema(NameIdentifier ident) throws NoSuchSchemaException {
    final NameIdentifier uniformIdent = getUniformNameIdentifier(ident);
    NameIdentifier catalogIdentifier = getCatalogIdentifier(uniformIdent);
    Schema schema =
        doWithCatalog(
            catalogIdentifier,
            c -> c.doWithSchemaOps(s -> s.loadSchema(uniformIdent)),
  ...
  public Schema alterSchema(NameIdentifier ident, SchemaChange... changes)
    ...
    final NameIdentifier uniformIdent = getUniformNameIdentifier(ident);
    validateAlterSchemaProperties(uniformIdent, changes);

    NameIdentifier catalogIdent = getCatalogIdentifier(uniformIdent);
    Schema tempAlteredSchema =
        doWithCatalog(
            catalogIdent,
            c -> c.doWithSchemaOps(s -> s.alterSchema(uniformIdent, changes)),
            NoSuchSchemaException.class);
        ...
        doWithCatalog(
            ...
            c ->
                c.doWithSchemaOps(
                    s ->
                        s.loadSchema(
                            NameIdentifier.of(uniformIdent.namespace(), tempAlteredSchema.name()))),
            NoSuchSchemaException.class);
  ...
  public boolean dropSchema(NameIdentifier ident, boolean cascade) throws NonEmptySchemaException {
    ...
    boolean dropped =
        doWithCatalog(
            getCatalogIdentifier(uniformIdent),
            c -> c.doWithSchemaOps(s -> s.dropSchema(uniformIdent, cascade)),
    ...
    try {
      store.delete(uniformIdent, SCHEMA, cascade);
    } catch (Exception e) {
  ...
  public NameIdentifier[] listTables(Namespace namespace) throws NoSuchSchemaException {
    final NameIdentifier uniformIdent =
        getUniformNameIdentifier(NameIdentifier.of(namespace, "dummy"));
    return doWithCatalog(
        getCatalogIdentifier(uniformIdent.parent()),
        c -> c.doWithTableOps(t -> t.listTables(uniformIdent.namespace())),
        NoSuchSchemaException.class);
  }
  ...
  public Table loadTable(NameIdentifier ident) throws NoSuchTableException {
    ...
    Table table =
        doWithCatalog(
            catalogIdentifier,
            c -> c.doWithTableOps(t -> t.loadTable(uniformIdent)),
  ...
  public Table alterTable(NameIdentifier ident, TableChange... changes)
    ...
    final NameIdentifier uniformIdent = getUniformNameIdentifier(ident);
    validateAlterTableProperties(uniformIdent, changes);

    NameIdentifier catalogIdent = getCatalogIdentifier(uniformIdent);
    Table tempAlteredTable =
        doWithCatalog(
            catalogIdent,
            c -> c.doWithTableOps(t -> t.alterTable(uniformIdent, changes)),
            NoSuchTableException.class,
            IllegalArgumentException.class);
        ...
        doWithCatalog(
            ...
            c ->
                c.doWithTableOps(
                    t ->
                        t.loadTable(
                            NameIdentifier.of(uniformIdent.namespace(), tempAlteredTable.name()))),
            NoSuchTableException.class);
    ...
    if (stringId == null) {
      return EntityCombinedTable.of(alteredTable)
          .withHiddenPropertiesSet(
              getHiddenTablePropertyNames(
                  getCatalogIdentifier(uniformIdent), alteredTable.properties()));
    }
  ...
  public boolean dropTable(NameIdentifier ident) {
    ...
    boolean dropped =
        doWithCatalog(
            getCatalogIdentifier(uniformIdent),
            c -> c.doWithTableOps(t -> t.dropTable(uniformIdent)),
            NoSuchTableException.class);
    ...
    try {
      store.delete(uniformIdent, TABLE);
    } catch (Exception e) {
      throw new RuntimeException(e);
    }
  ...
  public boolean purgeTable(NameIdentifier ident) throws UnsupportedOperationException {
    ...
    boolean purged =
        doWithCatalog(
            getCatalogIdentifier(uniformIdent),
            c -> c.doWithTableOps(t -> t.purgeTable(uniformIdent)),
            NoSuchTableException.class,
  ...
  private NameIdentifier getUniformNameIdentifier(NameIdentifier ident) {
    ...
    return identifierWithCaseSensitivity(
        ident,
        schemaAndTableNameCaseSensitivity.getLeft(),
        schemaAndTableNameCaseSensitivity.getRight());
  }
