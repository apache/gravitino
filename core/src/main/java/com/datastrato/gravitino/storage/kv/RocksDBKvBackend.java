...
/**
 * {@link RocksDBKvBackend} is a RocksDB implementation of KvBackend interface.
 * If we want to use
 * another kv implementation, We can just implement {@link KvBackend} interface
 * and use it in the
 * Gravitino.
 */
public class RocksDBKvBackend implements KvBackend {
    ...
    /**
     * Initialize the RocksDB backend instance. We have used the
     * {@link TransactionDB} to support
