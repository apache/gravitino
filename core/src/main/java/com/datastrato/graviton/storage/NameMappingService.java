...
public interface NameMappingService extends AutoCloseable {
   ...
   * name mapping. ID will be generated by {@link IdGenerator}.
   *
   ...
   * @throws IOException if the underlying storage failed
   */
  long bindNameAndId(String name) throws IOException;

  /**
   * Get id from name. If the name does not exist, we will create a new id for the name.
   *
   * @param name the name of the entity
   * @return the id of the name
   * @throws IOException if the underlying storage failed
