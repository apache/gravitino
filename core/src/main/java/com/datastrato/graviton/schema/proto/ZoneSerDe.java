...
class ZoneSerDe implements ProtoSerDe<com.datastrato.graviton.schema.Zone, Zone> {
  @Override
  public Zone serialize(com.datastrato.graviton.schema.Zone zone) {
  ...
  @Override
  public com.datastrato.graviton.schema.Zone deserialize(Zone p) {
    com.datastrato.graviton.schema.Zone.Builder builder =
