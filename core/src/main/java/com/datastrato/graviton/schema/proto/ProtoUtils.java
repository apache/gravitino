...
class ProtoUtils {
  ...
  static {
    Map<Class<? extends Entity>, ProtoSerDe<? extends Entity, ? extends MessageLite>> tmp =
        new HashMap<>();
    tmp.put(com.datastrato.graviton.schema.AuditInfo.class, new AuditInfoSerDe());
    tmp.put(com.datastrato.graviton.schema.Tenant.class, new TenantSerDe());
    tmp.put(com.datastrato.graviton.schema.Lakehouse.class, new LakehouseSerDe());
    tmp.put(com.datastrato.graviton.schema.Zone.class, new ZoneSerDe());
    tmp.put(com.datastrato.graviton.schema.Table.class, new TableSerDe());
    tmp.put(com.datastrato.graviton.schema.Column.class, new ColumnSerDe());
