...
public class TestObjectPolicyResolver {
  ...
  public void testResolveByPresenceAndValueSelector() throws Exception {
    ...
    when(relationOperations.batchListEntitiesByRelation(
        ...
        .thenReturn(
            Arrays.asList(
                relation(domain, selected, PolicyTagSelector.tagValue("finance")),
                relation(classified, selected, null),
                relation(classified, disabled, null)));
    ...
    when(relationOperations.batchListEntitiesByRelation(
        ...
        .thenReturn(
            Collections.singletonList(
                relation(domain, policy, PolicyTagSelector.tagValue("finance"))));
  ...
  public void testRejectMixedSelectorResults() throws Exception {
    ...
    when(relationOperations.batchListEntitiesByRelation(
        ...
        .thenReturn(
            Arrays.asList(
                relation(domain, policy, PolicyTagSelector.tagValue("finance")),
                relation(classified, policy, PolicyTagSelector.tagValue("pii"))));
  ...
  private static RelationalEntity<PolicyEntity> relation(
      TagEntity tag, PolicyEntity policy, PolicyTagSelector selector) {
