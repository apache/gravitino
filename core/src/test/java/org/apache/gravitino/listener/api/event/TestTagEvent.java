...
public class TestTagEvent {
    ...
    void testGetTagForMetadataObjectFailureEvent() {
        ...
        Assertions.assertEquals(
            GravitinoRuntimeException.class, ((GetTagForMetadataObjectFailureEvent) event).exception().getClass()
        );
    ...
    void testListTagsForMetadataObjectFailureEvent() {
        ...
        Assertions.assertEquals(
            GravitinoRuntimeException.class, ((ListTagsForMetadataObjectFailureEvent) event).exception().getClass()
        );
        Assertions.assertEquals("metalake", ((ListTagsForMetadataObjectFailureEvent) event).metalake());
        Assertions.assertEquals(metadataObject, ((ListTagsForMetadataObjectFailureEvent) event).metadataObject());
    ...
    void testListTagsInfoForMetadataObjectFailureEvent() {
        ...
        Assertions.assertEquals(
            GravitinoRuntimeException.class, ((ListTagsInfoForMetadataObjectFailureEvent) event).exception().getClass()
        );
        Assertions.assertEquals("metalake", ((ListTagsInfoForMetadataObjectFailureEvent) event).metalake());
        Assertions.assertEquals(metadataObject, ((ListTagsInfoForMetadataObjectFailureEvent) event).metadataObject());
        Assertions.assertEquals(OperationType.LIST_TAGS_INFO_FOR_METADATA_OBJECT, event.operationType());
        Assertions.assertEquals(OperationStatus.FAILURE, event.operationStatus());
    }
    ...
    void testAssociateTagsForMetadataObjectFailureEvent() {
        ...
        Assertions.assertEquals(
            GravitinoRuntimeException.class, ((AssociateTagsForMetadataObjectFailureEvent) event).exception().getClass()
        );
        Assertions.assertEquals("metalake", ((AssociateTagsForMetadataObjectFailureEvent) event).metalake());
        Assertions.assertEquals(metadataObject, ((AssociateTagsForMetadataObjectFailureEvent) event).metadataObject());
        Assertions.assertEquals(tagsToAssociate, ((AssociateTagsForMetadataObjectFailureEvent) event).tagsToAdd());
        Assertions.assertEquals(tagsToDisassociate, ((AssociateTagsForMetadataObjectFailureEvent) event).tagsToRemove());
        Assertions.assertEquals(OperationType.ASSOCIATE_TAGS_FOR_METADATA_OBJECT, event.operationType());
        Assertions.assertEquals(OperationStatus.FAILURE, event.operationStatus());
    }
