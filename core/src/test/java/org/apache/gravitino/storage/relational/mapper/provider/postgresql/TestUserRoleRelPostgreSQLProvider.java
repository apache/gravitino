...
public class TestUserRoleRelPostgreSQLProvider {
  ...
  void testSoftDeleteUserRoleRelByUserAndRolesWithEmptyRoles() {
    UserRoleRelPostgreSQLProvider provider = new UserRoleRelPostgreSQLProvider();
    String script = provider.softDeleteUserRoleRelByUserAndRoles(1L, Collections.emptyList());
  ...
  void testSoftDeleteUserRoleRelByUserAndRolesWithNonEmptyRoles() {
    UserRoleRelPostgreSQLProvider provider = new UserRoleRelPostgreSQLProvider();
    String script = provider.softDeleteUserRoleRelByUserAndRoles(1L, Arrays.asList(100L, 200L));
