...
public class TestManagedFunctionOperations {
  ...
  public void testAlterFunctionUpdateComment() {
    ...
    Assertions.assertEquals(1, updatedFunc.version());
    ...
    Assertions.assertEquals(1, loadedFunc.version());
  }
  ...
  public void testAlterFunctionAddImpl() {
    ...
    FunctionImpl sparkImpl =
        FunctionImpl.ofJava(FunctionImpl.RuntimeType.SPARK, "com.example.SparkUDF");
    FunctionDefinition[] definitions =
    ...
    FunctionImpl trinoImpl =
        FunctionImpl.ofJava(FunctionImpl.RuntimeType.TRINO, "com.example.TrinoUDF");
    org.apache.gravitino.function.Function updatedFunc =
  ...
  public void testAlterFunctionAddImplDuplicateRuntime() {
    ...
    FunctionImpl anotherSparkImpl =
        FunctionImpl.ofJava(FunctionImpl.RuntimeType.SPARK, "com.example.AnotherSparkUDF");
  ...
  public void testAlterFunctionAddImplToNonExistingDefinition() {
    ...
    FunctionParam[] nonExistingParams =
        new FunctionParam[] {FunctionParams.of("x", Types.StringType.get())};
    FunctionImpl impl = FunctionImpl.ofJava(FunctionImpl.RuntimeType.TRINO, "com.example.TrinoUDF");
  ...
  public void testAlterFunctionUpdateImpl() {
    ...
    FunctionParam[] params = new FunctionParam[] {FunctionParams.of("a", Types.IntegerType.get())};
    FunctionImpl sparkImpl =
        FunctionImpl.ofJava(FunctionImpl.RuntimeType.SPARK, "com.example.OldSparkUDF");
    FunctionDefinition[] definitions =
        new FunctionDefinition[] {
          createDefinitionWithImpls(params, new FunctionImpl[] {sparkImpl})
        };
    ...
    FunctionImpl newSparkImpl =
        FunctionImpl.ofJava(FunctionImpl.RuntimeType.SPARK, "com.example.NewSparkUDF");
    org.apache.gravitino.function.Function updatedFunc =
        functionOperations.alterFunction(
            funcIdent,
  ...
  public void testVersionIncrement() {
    NameIdentifier funcIdent = getFunctionIdent("func_version");
    FunctionParam[] params = new FunctionParam[] {FunctionParams.of("a", Types.IntegerType.get())};
    FunctionDefinition[] definitions = new FunctionDefinition[] {createSimpleDefinition(params)};

    org.apache.gravitino.function.Function v0 =
        functionOperations.registerFunction(
            funcIdent,
            "v0 comment",
            FunctionType.SCALAR,
    ...
    org.apache.gravitino.function.Function v1 =
        functionOperations.alterFunction(funcIdent, FunctionChange.updateComment("v1 comment"));
    Assertions.assertEquals(1, v1.version());

    org.apache.gravitino.function.Function v2 =
        functionOperations.alterFunction(funcIdent, FunctionChange.updateComment("v2 comment"));
    Assertions.assertEquals(2, v2.version());

    // Get function should return latest version
    org.apache.gravitino.function.Function latest = functionOperations.getFunction(funcIdent);
    Assertions.assertEquals(2, latest.version());
    Assertions.assertEquals("v2 comment", latest.comment());
  }
  ...
  private FunctionDefinition createSimpleDefinition(FunctionParam[] params) {
    FunctionImpl impl = FunctionImpl.ofJava(FunctionImpl.RuntimeType.SPARK, "com.example.TestUDF");
