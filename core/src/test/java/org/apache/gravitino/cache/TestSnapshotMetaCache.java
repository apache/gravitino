...
public class TestSnapshotMetaCache {

  private EntityStore mockStore;
  private SnapshotMetaCache real;
  private SnapshotMetaCache cache;
  ...
  void restoreStore() {
    ...
    SnapshotMetaCache.resetForTest();
    real = SnapshotMetaCache.getInstance(new CacheConfig(), mockStore);
    cache = spy(real);
    initIdMock();
  }
