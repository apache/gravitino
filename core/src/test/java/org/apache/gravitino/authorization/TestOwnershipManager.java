...
public class TestOwnershipManager {
  ...
  public void testOwner() {
    ...
    ownershipManager.setOwner(
        NameIdentifier.of(METALAKE), Entity.EntityType.METALAKE, USER, Owner.Type.USER.name());
    ...
    ownershipManager.setOwner(
        NameIdentifier.of(METALAKE), Entity.EntityType.METALAKE, GROUP, Owner.Type.GROUP.name());
