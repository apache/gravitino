...
public class TestCompatibilityUtils {
  ...
  public void testToAuditLogOperation() {
    Object[][] testCases = {
      ...
      {OperationType.FETCH_PLANNING_RESULT, Operation.FETCH_PLANNING_RESULT},
      {OperationType.CANCEL_PLANNING, Operation.CANCEL_PLANNING},
      ...
      {OperationType.REMOVE_USER_BY_EXTERNAL_ID, Operation.REMOVE_USER_BY_EXTERNAL_ID},
      {OperationType.GET_USER, Operation.GET_USER},
      {OperationType.GET_USER_BY_EXTERNAL_ID, Operation.GET_USER_BY_EXTERNAL_ID},
      {OperationType.GET_USER_BY_ID, Operation.GET_USER_BY_ID},
      {OperationType.REMOVE_USER_BY_ID, Operation.REMOVE_USER_BY_ID},
      {OperationType.ALTER_USER, Operation.ALTER_USER},
      ...
      {OperationType.REMOVE_GROUP_BY_EXTERNAL_ID, Operation.REMOVE_GROUP_BY_EXTERNAL_ID},
      {OperationType.GET_GROUP, Operation.GET_GROUP},
      {OperationType.GET_GROUP_BY_EXTERNAL_ID, Operation.GET_GROUP_BY_EXTERNAL_ID},
