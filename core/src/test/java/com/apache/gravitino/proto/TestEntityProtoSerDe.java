...
import com.apache.gravitino.EntitySerDeFactory;
...
import com.apache.gravitino.meta.GroupEntity;
...
public class TestEntityProtoSerDe {
  ...
  public void testAuditInfoSerDe() throws IOException {
    ...
    com.apache.gravitino.meta.AuditInfo auditInfo =
        com.apache.gravitino.meta.AuditInfo.builder()
            .withCreator(creator)
            .withCreateTime(now)
    ...
    com.apache.gravitino.meta.AuditInfo auditInfoFromBytes =
        protoEntitySerDe.deserialize(
            bytes, com.apache.gravitino.meta.AuditInfo.class, Namespace.empty());
    Assertions.assertEquals(auditInfo, auditInfoFromBytes);

    // Test with optional fields
    com.apache.gravitino.meta.AuditInfo auditInfo1 =
        com.apache.gravitino.meta.AuditInfo.builder()
            .withCreator(creator)
            .withCreateTime(now)
            .build();
    ...
    com.apache.gravitino.meta.AuditInfo auditInfo2 =
        com.apache.gravitino.meta.AuditInfo.builder().build();

    byte[] bytes1 = protoEntitySerDe.serialize(auditInfo2);
    com.apache.gravitino.meta.AuditInfo auditInfoFromBytes1 =
        protoEntitySerDe.deserialize(
            bytes1, com.apache.gravitino.meta.AuditInfo.class, Namespace.empty());
  ...
  public void testEntitiesSerDe() throws IOException {
    ...
    // Test Metalake
    com.apache.gravitino.meta.BaseMetalake metalake =
        com.apache.gravitino.meta.BaseMetalake.builder()
            .withId(metalakeId)
    ...
    com.apache.gravitino.meta.BaseMetalake metalakeFromBytes =
        protoEntitySerDe.deserialize(
            metalakeBytes, com.apache.gravitino.meta.BaseMetalake.class, Namespace.empty());
    Assertions.assertEquals(metalake, metalakeFromBytes);

    // Test metalake without props map
    com.apache.gravitino.meta.BaseMetalake metalake1 =
        com.apache.gravitino.meta.BaseMetalake.builder()
            .withId(metalakeId)
            .withName(metalakeName)
            .withAuditInfo(auditInfo)
    ...
    com.apache.gravitino.meta.BaseMetalake metalakeFromBytes1 =
        protoEntitySerDe.deserialize(
            metalakeBytes1, com.apache.gravitino.meta.BaseMetalake.class, Namespace.empty());
    ...
    com.apache.gravitino.meta.CatalogEntity catalogEntity =
        com.apache.gravitino.meta.CatalogEntity.builder()
            .withId(catalogId)
    ...
    com.apache.gravitino.meta.CatalogEntity catalogEntityFromBytes =
        protoEntitySerDe.deserialize(
            catalogBytes, com.apache.gravitino.meta.CatalogEntity.class, catalogNamespace);
    Assertions.assertEquals(catalogEntity, catalogEntityFromBytes);

    // Test Fileset catalog
    com.apache.gravitino.meta.CatalogEntity filesetCatalogEntity =
        com.apache.gravitino.meta.CatalogEntity.builder()
            .withId(catalogId)
            .withName(catalogName)
            .withNamespace(catalogNamespace)
    ...
    com.apache.gravitino.meta.CatalogEntity filesetCatalogEntityFromBytes =
        protoEntitySerDe.deserialize(
            filesetCatalogBytes, com.apache.gravitino.meta.CatalogEntity.class, catalogNamespace);
    ...
    com.apache.gravitino.meta.SchemaEntity schemaEntity =
        com.apache.gravitino.meta.SchemaEntity.builder()
            .withId(schemaId)
            .withName(schemaName)
    ...
    com.apache.gravitino.meta.SchemaEntity schemaEntityFromBytes =
        protoEntitySerDe.deserialize(
            schemaBytes, com.apache.gravitino.meta.SchemaEntity.class, schemaNamespace);
    Assertions.assertEquals(schemaEntity, schemaEntityFromBytes);

    // Test SchemaEntity with additional fields
    com.apache.gravitino.meta.SchemaEntity schemaEntity1 =
        com.apache.gravitino.meta.SchemaEntity.builder()
            .withId(schemaId)
            .withName(schemaName)
            .withNamespace(schemaNamespace)
    ...
    com.apache.gravitino.meta.SchemaEntity schemaEntityFromBytes1 =
        protoEntitySerDe.deserialize(
            schemaBytes1, com.apache.gravitino.meta.SchemaEntity.class, schemaNamespace);
    ...
    com.apache.gravitino.meta.TableEntity tableEntity =
        com.apache.gravitino.meta.TableEntity.builder()
            .withId(tableId)
            .withName(tableName)
    ...
    com.apache.gravitino.meta.TableEntity tableEntityFromBytes =
        protoEntitySerDe.deserialize(
            tableBytes, com.apache.gravitino.meta.TableEntity.class, tableNamespace);
    ...
    com.apache.gravitino.meta.FilesetEntity fileEntity =
        com.apache.gravitino.meta.FilesetEntity.builder()
            .withId(fileId)
            .withName(fileName)
    ...
    com.apache.gravitino.meta.FilesetEntity fileEntityFromBytes =
        protoEntitySerDe.deserialize(
            fileBytes, com.apache.gravitino.meta.FilesetEntity.class, filesetNamespace);
    Assertions.assertEquals(fileEntity, fileEntityFromBytes);

    com.apache.gravitino.meta.FilesetEntity fileEntity1 =
        com.apache.gravitino.meta.FilesetEntity.builder()
            .withId(fileId)
            .withName(fileName)
            .withNamespace(filesetNamespace)
    ...
    com.apache.gravitino.meta.FilesetEntity fileEntityFromBytes1 =
        protoEntitySerDe.deserialize(
            fileBytes1, com.apache.gravitino.meta.FilesetEntity.class, filesetNamespace);
    ...
    com.apache.gravitino.meta.FilesetEntity fileEntity2 =
        com.apache.gravitino.meta.FilesetEntity.builder()
            .withId(fileId)
            .withName(fileName)
            .withNamespace(filesetNamespace)
    ...
    com.apache.gravitino.meta.FilesetEntity fileEntityFromBytes2 =
        protoEntitySerDe.deserialize(
            fileBytes2, com.apache.gravitino.meta.FilesetEntity.class, filesetNamespace);
    ...
    com.apache.gravitino.meta.TopicEntity topicEntity =
        com.apache.gravitino.meta.TopicEntity.builder()
            .withId(topicId)
            .withName(topicName)
    ...
    com.apache.gravitino.meta.TopicEntity topicEntityFromBytes =
        protoEntitySerDe.deserialize(
            topicBytes, com.apache.gravitino.meta.TopicEntity.class, topicNamespace);
    Assertions.assertEquals(topicEntity, topicEntityFromBytes);

    com.apache.gravitino.meta.TopicEntity topicEntity1 =
        com.apache.gravitino.meta.TopicEntity.builder()
            .withId(topicId)
            .withName(topicName)
            .withNamespace(topicNamespace)
    ...
    com.apache.gravitino.meta.TopicEntity topicEntityFromBytes1 =
        protoEntitySerDe.deserialize(
            topicBytes1, com.apache.gravitino.meta.TopicEntity.class, topicNamespace);
