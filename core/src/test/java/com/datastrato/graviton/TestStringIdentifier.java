...
public class TestStringIdentifier {
  ...
  public void testCreateStringIdentifierFromString() {
    long uid = 123123L;
    String idString = "graviton.v1.uid" + uid;
    ...
    String idStringV2 = "graviton.v2.uid" + uid;
    Throwable ex =
    ...
    String idStringInvalid = "graviton.v1.uid" + uid + ".invalid";
    Throwable ex1 =
        Assertions.assertThrows(
    ...
    Assertions.assertThrows(
        ...
        () -> StringIdentifier.fromString("graviton.v1.uidfdsafdsa"));
    Assertions.assertThrows(
        IllegalArgumentException.class, () -> StringIdentifier.fromString("graviton.v1.uid"));
    Assertions.assertThrows(
        IllegalArgumentException.class, () -> StringIdentifier.fromString("graviton.v1.uid1.1"));
    Assertions.assertThrows(
        IllegalArgumentException.class, () -> StringIdentifier.fromString("graviton.v1.uid1.1.1"));
  }
