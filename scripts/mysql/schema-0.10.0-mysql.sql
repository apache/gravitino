...
CREATE TABLE IF NOT EXISTS `metalake_meta` (
    ...
    `metalake_comment` TEXT DEFAULT '' COMMENT 'metalake comment',
...
CREATE TABLE IF NOT EXISTS `catalog_meta` (
    ...
    `catalog_comment` TEXT DEFAULT '' COMMENT 'catalog comment',
...
CREATE TABLE IF NOT EXISTS `schema_meta` (
    ...
    `metalake_id` BIGINT(20) UNSIGNED NOT NULL COMMENT 'metalake id',
    `catalog_id` BIGINT(20) UNSIGNED NOT NULL COMMENT 'catalog id',
    `schema_comment` TEXT DEFAULT '' COMMENT 'schema comment',
...
CREATE TABLE IF NOT EXISTS `table_column_version_info` (
    ...
    `column_comment` TEXT DEFAULT '' COMMENT 'column comment',
...
CREATE TABLE IF NOT EXISTS `fileset_version_info` (
    ...
    `fileset_comment` TEXT DEFAULT '' COMMENT 'fileset comment',
...
CREATE TABLE IF NOT EXISTS `topic_meta` (
    ...
    `catalog_id` BIGINT(20) UNSIGNED NOT NULL COMMENT 'catalog id',
    `schema_id` BIGINT(20) UNSIGNED NOT NULL COMMENT 'schema id',
    `comment` TEXT DEFAULT '' COMMENT 'topic comment',
...
CREATE TABLE IF NOT EXISTS `tag_meta` (
    ...
    `metalake_id` BIGINT(20) UNSIGNED NOT NULL COMMENT 'metalake id',
    `tag_comment` TEXT DEFAULT '' COMMENT 'tag comment',
