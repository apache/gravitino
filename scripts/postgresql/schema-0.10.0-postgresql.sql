...
CREATE TABLE IF NOT EXISTS metalake_meta (
    ...
    metalake_comment VARCHAR(65535) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS catalog_meta (
    ...
    catalog_comment VARCHAR(65535) DEFAULT '',
    properties TEXT DEFAULT NULL,
    audit_info TEXT NOT NULL,
    current_version INT NOT NULL DEFAULT 1,
    last_version INT NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS schema_meta (
    ...
    metalake_id BIGINT NOT NULL,
    catalog_id BIGINT NOT NULL,
    schema_comment VARCHAR(65535) DEFAULT '',
    properties TEXT DEFAULT NULL,
    audit_info TEXT NOT NULL,
    current_version INT NOT NULL DEFAULT 1,
    last_version INT NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS table_column_version_info (
    ...
    column_comment VARCHAR(65535) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS fileset_version_info (
                                                    ...
                                                    fileset_comment VARCHAR(65535) DEFAULT '',
    properties TEXT DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS tag_meta (
    ...
    metalake_id BIGINT NOT NULL,
    tag_comment VARCHAR(65535) DEFAULT '',
    properties TEXT DEFAULT NULL,
    audit_info TEXT NOT NULL,
    current_version INT NOT NULL DEFAULT 1,
    last_version INT NOT NULL DEFAULT 1,
