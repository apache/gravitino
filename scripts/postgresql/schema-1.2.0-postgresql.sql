...
CREATE TABLE IF NOT EXISTS table_column_version_info (
    ...
    column_nullable BOOLEAN NOT NULL DEFAULT true,
    column_auto_increment BOOLEAN NOT NULL DEFAULT false,
    column_default_value TEXT DEFAULT NULL,
    column_op_type INT NOT NULL,
    deleted_at BIGINT NOT NULL DEFAULT 0,
    audit_info TEXT NOT NULL,
...
COMMENT ON COLUMN table_column_version_info.column_nullable IS 'column nullable, false is not nullable, true is nullable';
COMMENT ON COLUMN table_column_version_info.column_auto_increment IS 'column auto increment, false is not auto increment, true is auto increment';
...
CREATE INDEX IF NOT EXISTS table_column_version_info_idx_metalake_id ON table_column_version_info (metalake_id);
CREATE INDEX IF NOT EXISTS table_column_version_info_idx_catalog_id ON table_column_version_info (catalog_id);
CREATE INDEX IF NOT EXISTS table_column_version_info_idx_schema_id ON table_column_version_info (schema_id);
...
CREATE INDEX IF NOT EXISTS fileset_version_info_idx_catalog_id ON fileset_version_info (catalog_id);
CREATE INDEX IF NOT EXISTS fileset_version_info_idx_schema_id ON fileset_version_info (schema_id);

COMMENT ON TABLE fileset_version_info IS 'fileset version info';
...
CREATE TABLE IF NOT EXISTS role_meta_securable_object (
    ...
    privilege_conditions TEXT NOT NULL,
    current_version INT NOT NULL DEFAULT 1,
    last_version INT NOT NULL DEFAULT 1,
    deleted_at BIGINT NOT NULL DEFAULT 0,
    UNIQUE (role_id, metadata_object_id, deleted_at)
    );

CREATE INDEX IF NOT EXISTS idx_role_meta_securable_object_rid ON role_meta_securable_object (role_id);
CREATE INDEX IF NOT EXISTS idx_role_meta_securable_object_eid ON role_meta_securable_object (metadata_object_id);

COMMENT ON TABLE role_meta_securable_object IS 'securable object meta';
...
CREATE INDEX IF NOT EXISTS idx_user_role_rel_rid ON user_role_rel (role_id);

COMMENT ON TABLE user_role_rel IS 'user role relation';
...
CREATE INDEX IF NOT EXISTS idx_group_role_rel_rid ON group_role_rel (group_id);

COMMENT ON TABLE group_role_rel IS 'group role relation';
...
CREATE INDEX IF NOT EXISTS idx_tag_relation_meta_tid ON tag_relation_meta (tag_id);
CREATE INDEX IF NOT EXISTS idx_tag_relation_meta_mid ON tag_relation_meta (metadata_object_id);
...
CREATE TABLE IF NOT EXISTS model_meta (
    ...
    catalog_id BIGINT NOT NULL,
    schema_id BIGINT NOT NULL,
    model_comment TEXT DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS model_version_info (
                                                 ...
                                                 model_id BIGINT NOT NULL,
                                                 version INT NOT NULL,
                                                 model_version_comment TEXT DEFAULT NULL,
...
CREATE INDEX IF NOT EXISTS model_version_alias_rel_idx_mva ON model_version_alias_rel (model_version_alias);

COMMENT ON TABLE model_version_alias_rel IS 'model_version_alias_rel';
...
COMMENT ON COLUMN policy_version_info.enabled IS 'whether the policy is enabled, false is disabled, true is enabled';
...
CREATE INDEX IF NOT EXISTS policy_relation_meta_idx_pid ON policy_relation_meta (policy_id);
CREATE INDEX IF NOT EXISTS policy_relation_meta_idx_mid ON policy_relation_meta (metadata_object_id);
