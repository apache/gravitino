...
CREATE TABLE IF NOT EXISTS lance_table_version_info (
    ...
    manifest_size BIGINT DEFAULT NULL,
    e_tag VARCHAR(256) DEFAULT NULL,
    naming_scheme VARCHAR(64) DEFAULT NULL,
...
CREATE INDEX IF NOT EXISTS lance_table_version_info_idx_metalake_id ON lance_table_version_info (metalake_id);
CREATE INDEX IF NOT EXISTS lance_table_version_info_idx_catalog_id ON lance_table_version_info (catalog_id);
CREATE INDEX IF NOT EXISTS lance_table_version_info_idx_schema_id ON lance_table_version_info (schema_id);
COMMENT ON TABLE lance_table_version_info IS 'lance table version information';

COMMENT ON COLUMN lance_table_version_info.id IS 'auto increment id';
COMMENT ON COLUMN lance_table_version_info.metalake_id IS 'metalake id';
COMMENT ON COLUMN lance_table_version_info.catalog_id IS 'catalog id';
COMMENT ON COLUMN lance_table_version_info.schema_id IS 'schema id';
COMMENT ON COLUMN lance_table_version_info.table_id IS 'table id';
COMMENT ON COLUMN lance_table_version_info.version IS 'lance table version';
COMMENT ON COLUMN lance_table_version_info.manifest_path IS 'manifest path';
COMMENT ON COLUMN lance_table_version_info.manifest_size IS 'manifest size';
COMMENT ON COLUMN lance_table_version_info.e_tag IS 'object store etag';
COMMENT ON COLUMN lance_table_version_info.naming_scheme IS 'manifest naming scheme';
COMMENT ON COLUMN lance_table_version_info.metadata_json IS 'version metadata';
COMMENT ON COLUMN lance_table_version_info.context_json IS 'request context';
COMMENT ON COLUMN lance_table_version_info.created_at IS 'created at';
COMMENT ON COLUMN lance_table_version_info.created_by IS 'created by';
COMMENT ON COLUMN lance_table_version_info.request_id IS 'request id';
COMMENT ON COLUMN lance_table_version_info.deleted_at IS 'version deleted at';
