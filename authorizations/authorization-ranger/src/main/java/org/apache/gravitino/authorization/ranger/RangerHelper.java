...
public class RangerHelper {
   ...
   */
  public List<RangerPolicy> findManagedPolicies(RangerMetadataObject rangerMetadataObject)
      throws AuthorizationPluginException {
  ...
  public RangerPolicy findManagedPolicy(RangerMetadataObject rangerMetadataObject)
      throws AuthorizationPluginException {
    List<RangerPolicy> policies = findManagedPolicies(rangerMetadataObject);
    if (!policies.isEmpty()) {
      /**
