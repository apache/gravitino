...
public class RangerIcebergE2EIT extends BaseIT {
  ...
  private static final String SQL_ALTER_TABLE_BACK =
  ...
  void testCreateSchema() throws InterruptedException {
    // Fail to use catalog
    Assertions.assertThrows(AccessControlException.class, () -> sparkSession.sql(SQL_USE_CATALOG));
  ...
  void testWriteOnlyTable() throws InterruptedException {
    ...
    // case 3: Fail to update data in the table
    Assertions.assertThrows(AccessControlException.class, () -> sparkSession.sql(SQL_UPDATE_TABLE));
