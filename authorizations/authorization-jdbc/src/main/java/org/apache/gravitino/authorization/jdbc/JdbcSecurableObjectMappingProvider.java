...
public class JdbcSecurableObjectMappingProvider implements AuthorizationPrivilegesMappingProvider {
    ...
    private final Map<Privilege.Name, Set<AuthorizationPrivilege>> privilegeMapping = ImmutableMap.of(
            ...
            Privilege.Name.MODIFY_TABLE, Sets.newHashSet(JdbcPrivilege.valueOf(JdbcPrivilege.Type.SELECT), JdbcPrivilege.valueOf(JdbcPrivilege.Type.UPDATE), JdbcPrivilege.valueOf(JdbcPrivilege.Type.DELETE), JdbcPrivilege.valueOf(JdbcPrivilege.Type.INSERT)),
            Privilege.Name.USE_SCHEMA, Sets.newHashSet(JdbcPrivilege.valueOf(JdbcPrivilege.Type.USAGE))
    );
