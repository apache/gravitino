...
public class CatalogHiveIT extends AbstractIT {
  ...
  public static void startup() throws Exception {
    ...
    hiveConf.setInt(HiveConf.ConfVars.METASTORETHRIFTFAILURERETRIES.varname, 10);
    hiveConf.setTimeVar(
        HiveConf.ConfVars.METASTORE_CLIENT_CONNECT_RETRY_DELAY, 30, TimeUnit.SECONDS);
  ...
  public void testAlterHiveTable() throws TException, InterruptedException {
    LOG.info(
        "testAlterHiveTable metalakeName = "
            + metalakeName
            + " catalogName = "
            + catalogName
            + " schemaName = "
  ...
  public void testDropHiveTable() {
    LOG.info(
        "testDropHiveTable metalakeName = "
            + metalakeName
            + " catalogName = "
            + catalogName
            + " schemaName = "
