...
public class MultiAuthOperationsIT extends AbstractIT {
    ...
    private static GravitinoAdminClient simpleClient;
  ...
  public static void startIntegrationTest() throws Exception {
    ...
    configs.put(Configs.AUTHENTICATOR.getKey(), String.join(",", AuthenticatorType.KERBEROS.name().toLowerCase(), AuthenticatorType.OAUTH.name().toLowerCase()));
      configOAuth(configs);
    ...
    AbstractIT.startIntegrationTest();
      ...
      simpleClient = GravitinoAdminClient.builder(serverUri).withSimpleAuth().build();

      oauthClient = GravitinoAdminClient.builder(serverUri).withOAuth(OAuthMockDataProvider.getInstance()).build();
  ...
  @Test
  public void testNotSupportAuthenticator() {
      simpleClient.serverVersion();
