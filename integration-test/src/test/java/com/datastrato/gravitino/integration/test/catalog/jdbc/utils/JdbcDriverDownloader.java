 ...
 */
package com.datastrato.gravitino.integration.test.catalog.jdbc.utils;
...
public class JdbcDriverDownloader {
  ...
  public static void downloadJdbcDriver(String jdbcDriverUrl, String destinationDirectory)
      throws IOException {
