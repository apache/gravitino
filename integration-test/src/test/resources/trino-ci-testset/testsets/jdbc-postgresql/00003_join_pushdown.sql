...
CREATE TABLE "test.gt_postgresql".gt_db1.employee_performance (
   employee_id integer,
...
CREATE TABLE "test.gt_postgresql".gt_db1.employees (
  employee_id integer,
...
INSERT INTO "test.gt_postgresql".gt_db1.employee_performance (employee_id, evaluation_date, rating) VALUES
(1, DATE '2018-02-24', 4),
(1, DATE '2016-12-25', 7),
(1, DATE '2023-04-07', 4),
(3, DATE '2012-11-08', 7),
...
INSERT INTO "test.gt_postgresql".gt_db1.employees (employee_id, department_id, job_title, given_name, family_name, birth_date, hire_date) VALUES
...
SELECT
  ...
  family_name,
  rating
FROM "test.gt_postgresql".gt_db1.employee_performance AS p
...
drop table "test.gt_postgresql".gt_db1.employees;
