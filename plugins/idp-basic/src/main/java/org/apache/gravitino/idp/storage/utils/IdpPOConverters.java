...
/** Converters between built-in IdP persistence objects and domain models. */
public final class IdpPOConverters {
   ...
   */
  public static IdpUser toIdpUser(IdpUserWithGroupsPO userPO) {
    Objects.requireNonNull(userPO, "userPO must not be null");
    return new IdpUser(userPO.getName(), parseGroupNames(userPO.getGroupNames()));
  }
