...
public class IdpGroupMetaService {
  ...
  private IdpGroupPO getIdpGroupPOByName(String groupName) {
    ...
    if (groupPO == null) {
      throw new NoSuchEntityException(
          NoSuchEntityException.NO_SUCH_ENTITY_MESSAGE, IDP_GROUP_ENTITY_TYPE, groupName);
    }
    return groupPO;
  }
  ...
  @Monitored(
      metricsSource = GRAVITINO_RELATIONAL_STORE_METRIC_NAME,
      baseMetricName = "listAllIdpGroups")
  public List<IdpGroupPO> listAllIdpGroups() {
    return listIdpGroups(Collections.emptyList());
  }
