...
public class IdpUserOperations {
  ...
  IdpUserOperations(BasicIdpManager idpManager) {
  ...
  public Response getUser(@PathParam("user") String user) {
    try {
      return Utils.doAs(
          httpRequest, () -> Utils.ok(new IdpUserResponse(idpManager.getIdpUser(user))));
    } catch (Exception e) {
    ...
    try {
      return Utils.doAs(
          ...
          () -> {
            ...
            return Utils.ok(
                new IdpUserResponse(
                    idpManager.createIdpUser(request.getUser(), request.getPassword())));
          });
    } catch (Exception e) {
    ...
    try {
      return Utils.doAs(
          ...
          () -> {
            request.validate();
            return Utils.ok(
                new IdpUserResponse(idpManager.resetIdpUserPassword(user, request.getPassword())));
          });
    } catch (Exception e) {
