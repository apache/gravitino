...
/** Initializes and closes JDBC sessions for built-in IdP storage. */
final class IdpJdbcSessionSupport {
  ...
  private static JDBCDatabase startEmbeddedDatabaseIfNecessary(Config config) {
    ...
    try {
      ...
      throw new RuntimeException("Failed to create and initialize IdP JDBC session.", e);
    }
  }
}
