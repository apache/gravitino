...
public class TestIdpGroupUserRelMapper extends IdpMapperTestBase {
  ...
  void testSoftDeleteIdpGroupUsers() {
    ...
    idpGroupUserRelMapper.softDeleteIdpGroupUsers(10L, List.of(1L), 50L);
    assertIterableEquals(List.of("bob"), idpGroupUserRelMapper.selectUserNamesByGroupId(10L));
    assertEquals(
        50L, queryLongValue("idp_group_user_rel", "deleted_at", "id", firstRelation.getId()));
    assertEquals(
  ...
  void testSoftDeleteGroupUsersByUserId() {
    ...
    idpGroupUserRelMapper.softDeleteGroupUsersByUserId(2L, 60L);
    assertIterableEquals(List.of("alice"), idpGroupUserRelMapper.selectUserNamesByGroupId(10L));
    assertEquals(
        60L, queryLongValue("idp_group_user_rel", "deleted_at", "id", secondRelation.getId()));
  }
  ...
  void testSoftDeleteGroupUsersByGroupId() {
    ...
    idpGroupUserRelMapper.softDeleteGroupUsersByGroupId(20L, 80L);
    assertTrue(idpGroupUserRelMapper.selectUserNamesByGroupId(20L).isEmpty());
    assertEquals(
        80L, queryLongValue("idp_group_user_rel", "deleted_at", "id", thirdRelation.getId()));
  }
