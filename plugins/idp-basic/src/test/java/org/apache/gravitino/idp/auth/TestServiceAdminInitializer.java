...
class TestServiceAdminInitializer {
  ...
  @Test
  void testInitializeCreatesMissingServiceAdmin() {
    config.loadFromMap(
        ImmutableMap.of(
  ...
  @Test
  void testInitializeSkipsWhenBasicAuthenticatorDisabledEvenIfPayloadInvalid() {
    config.loadFromMap(
        ImmutableMap.of(
  ...
  @Test
  void testInitializeSkipsWhenNoServiceAdminsConfigured() {
    config.loadFromMap(
        ImmutableMap.of(
            "gravitino.authenticators", "basic",
  ...
  @Test
  void testInitializeSkipsWhenAllServiceAdminsAlreadyExist() {
    config.loadFromMap(
        ImmutableMap.of(
            "gravitino.authenticators", "basic",
            "gravitino.authorization.serviceAdmins", "admin1,admin2"),
