...
RANGER_VERSION="distro-${RANGER_VERSION_NUMBER}"
RANGER_PACKAGE_NAME="ranger-${RANGER_VERSION}-admin.tar.gz" # Must export this variable for Dockerfile
RANGER_DOWNLOAD_URL="https://repo.maven.apache.org/maven2/org/apache/ranger/ranger-distro/${RANGER_VERSION_NUMBER}/${RANGER_PACKAGE_NAME}"
