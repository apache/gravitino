...
cd ${gravitino_home}
${gravitino_home}/gradlew :trino-connector:trino-connector-473-480:assembleTrinoConnector -x test
cp -r "${gravitino_home}/distribution/gravitino-trino-connector-473-480" "${trino_dir}/packages/gravitino-trino-connector"
