...
cd ${gravitino_home}
${gravitino_home}/gradlew :trino-connector:trino-connector-478:assembleTrinoConnector -x test
cp -r "${gravitino_home}/distribution/gravitino-trino-connector-478" "${trino_dir}/packages/gravitino-trino-connector"
