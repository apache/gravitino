...
env_map = {
    ...
    "GRAVITINO_ENTITY_STORE_JDBC_URL": "entity.store.relational.jdbcUrl",
    "GRAVITINO_ENTITY_STORE_JDBC_DRIVER": "entity.store.relational.jdbcDriver",
    "GRAVITINO_ENTITY_STORE_JDBC_USER": "entity.store.relational.jdbcUser",
    "GRAVITINO_ENTITY_STORE_JDBC_PASSWORD": "entity.store.relational.jdbcPassword",
