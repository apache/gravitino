...
env_map = {
    ...
    "GRAVITINO_SERVER_WEBSERVER_INCLUDE_ERROR_STACK_TRACE": "server.webserver.includeErrorStackTrace",
    ...
    "GRAVITINO_ICEBERG_REST_S3_PROXY_ENDPOINT": "iceberg-rest.s3-proxy-endpoint",
