...
export default function AddUserDialog({ ...props }) {
  const { open, setOpen, metalake, mutateUsers } = props
  ...
  const handleSubmit = e => {
    ...
    form
      ...
      .then(async () => {
        ...
        // await submitUser({ params: { metalake }, data: submitData })
        await dispatch(createUser({ metalake, data: submitData }))
  ...
  return (
    <>
      ...
      >
        <Paragraph type='secondary'>Add a user.</Paragraph>
        <Form
          form={form}
