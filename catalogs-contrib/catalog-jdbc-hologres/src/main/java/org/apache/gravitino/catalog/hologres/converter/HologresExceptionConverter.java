 ...
 *
 * <p>Hologres is PostgreSQL-compatible, so SQL error codes follow PostgreSQL conventions.
 *
 * @see <a href="https://www.postgresql.org/docs/current/errcodes-appendix.html#ERRCODES-TABLE">
