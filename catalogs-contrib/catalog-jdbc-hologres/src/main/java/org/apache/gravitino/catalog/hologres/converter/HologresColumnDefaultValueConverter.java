 ...
 *
 * <p>Hologres is PostgreSQL-compatible, so default value conversion follows PostgreSQL conventions.
 */
public class HologresColumnDefaultValueConverter extends JdbcColumnDefaultValueConverter {
  ...
  public Expression toGravitino(
    ...
    if (isExpression) {
      // The parsing of Hologres (PostgreSQL) expressions is complex, so we are not currently
