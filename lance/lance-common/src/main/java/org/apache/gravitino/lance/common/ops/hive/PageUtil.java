...
/** Pagination helper for the Hive Lance namespace list APIs. */
class PageUtil {
  ...
  static Page splitPage(List<String> items, String pageToken, int pageSize) {
    int startIndex = 0;
  ...
  /** A single page of items together with the token to fetch the next page. */
  static class Page {
