...
public class TestUserChange {
  ...
  void testUpdateEnabled() {
    UserChange.UpdateEnabled change = (UserChange.UpdateEnabled) UserChange.updateEnabled(false);
  ...
  void testUpdateExternalId() {
    ...
    Assertions.assertEquals(UserChange.updateExternalId(null), UserChange.updateExternalId(null));
