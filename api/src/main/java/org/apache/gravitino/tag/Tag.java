...
public interface Tag extends Auditable {
  ...
  /**
   * @return The assignment value constraint of the tag. The default means the tag has no value
   *     restriction and may be assigned without values or with any non-empty assignment value.
   */
