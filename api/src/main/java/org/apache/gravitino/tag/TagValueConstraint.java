...
public final class TagValueConstraint {
  ...
  public enum Type {
    /**
     * The tag has no assignment value restriction and accepts assignments with no value or with
     * values.
     */
    ANY_VALUE,
   ...
   *
   * <p>The tag may be assigned with no value or with any non-empty assignment value.
   *
