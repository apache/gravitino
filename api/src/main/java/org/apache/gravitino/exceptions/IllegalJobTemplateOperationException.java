...
public class IllegalJobTemplateOperationException extends IllegalArgumentException {
   ...
   */
  @FormatMethod
  public IllegalJobTemplateOperationException(@FormatString String message, Object... args) {
    super(String.format(message, args));
  }

  /**
   * Constructs a new IllegalJobTemplateOperationException with the specified detail message and
   * cause.
   *
