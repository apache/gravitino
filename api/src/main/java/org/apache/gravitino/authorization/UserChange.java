...
/**
 * A user change is a change to a user. It can be used to update the enabled flag or the optional
 * external id. Multiple changes may be applied in one {@code alterUserById} call.
 */
@Evolving
