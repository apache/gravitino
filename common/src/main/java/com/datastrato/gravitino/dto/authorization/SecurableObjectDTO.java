...
public class SecurableObjectDTO implements SecurableObject {
    ...
    public SecurableObject parent() {
        throw new UnsupportedOperationException("SecurableObjectDTO doesn't support the method `parent`");
    }
    ...
    public static class Builder {
        ...
        public SecurableObjectDTO build() {
            Preconditions.checkArgument(StringUtils.isNotBlank(fullName), "full name cannot be null or empty");
