...
/** Response for adding one policy-to-tag association. */
@Getter
@ToString
...
public class PolicyTagAssociationResponse extends BaseResponse {
  ...
  private final PolicyAssociationSelectorDTO selector;
  ...
  public PolicyTagAssociationResponse(
      String policy, String tag, PolicyAssociationSelectorDTO selector) {
    this.policy = policy;
    this.tag = tag;
