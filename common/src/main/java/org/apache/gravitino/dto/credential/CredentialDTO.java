...
public class CredentialDTO implements Credential {
  ...
  @JsonProperty("expire-time-in-ms")
  private long expireTimeInMs;

  @JsonProperty("credential-info")
  ...
  public static class Builder {
    ...
    /**
     * Sets the specific credential information.
     *
     * @param credentialInfo The specific credential information.
