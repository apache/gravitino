...
public class TestTypeUtils {
  ...
  public void testToGravitinoType() {
    ...
    // Comprehensive MapType tests covering all permutations of Flink map and value nullability
    // Gravitino MapType value nullability is derived from Flink map's value type nullability.
    // Flink MapType: isNullable (map itself), keyType, valueType
    // Gravitino MapType: keyType, valueType, valueNullable
    Assertions.assertEquals(
        Types.MapType.of(Types.StringType.get(), Types.IntegerType.get(), true),
        TypeUtils.toGravitinoType(
            new MapType(true, new VarCharType(true, Integer.MAX_VALUE), new IntType(true))));
    Assertions.assertEquals(
        Types.MapType.of(Types.StringType.get(), Types.IntegerType.get(), false),
        TypeUtils.toGravitinoType(
            new MapType(true, new VarCharType(true, Integer.MAX_VALUE), new IntType(false))));
    Assertions.assertEquals(
        Types.MapType.of(Types.StringType.get(), Types.IntegerType.get(), true),
        TypeUtils.toGravitinoType(
            new MapType(false, new VarCharType(true, Integer.MAX_VALUE), new IntType(true))));
    Assertions.assertEquals(
        Types.MapType.of(Types.StringType.get(), Types.IntegerType.get(), false),
        TypeUtils.toGravitinoType(
            new MapType(false, new VarCharType(true, Integer.MAX_VALUE), new IntType(false))));
  ...
  public void testToFlinkType() {
    ...
    Assertions.assertEquals(DataTypes.CHAR(10), TypeUtils.toFlinkType(Types.FixedCharType.of(10)));
    Assertions.assertEquals(
        DataTypes.BINARY(10), TypeUtils.toFlinkType(Types.FixedType.of(10)));
    Assertions.assertEquals(DataTypes.TIME(), TypeUtils.toFlinkType(Types.TimeType.of(0)));
    Assertions.assertEquals(
    ...
    Assertions.assertEquals(
        DataTypes.ARRAY(DataTypes.INT().notNull()),
        TypeUtils.toFlinkType(Types.ListType.nullable(Types.IntegerType.notNull())));
    Assertions.assertEquals(
    ...
    Assertions.assertEquals(
        DataTypes.ROW(
            DataTypes.FIELD("a", DataTypes.INT()), DataTypes.FIELD("b", DataTypes.INT().notNull())),
        TypeUtils.toFlinkType(
            Types.StructType.of(
                Types.StructType.Field.nullableField("a", Types.IntegerType.get()),
                Types.StructType.Field.notNullField("b", Types.IntegerType.get()))));
    Assertions.assertThrows(
        UnsupportedOperationException.class, () -> TypeUtils.toFlinkType(Types.UUIDType.get()));
  }
}