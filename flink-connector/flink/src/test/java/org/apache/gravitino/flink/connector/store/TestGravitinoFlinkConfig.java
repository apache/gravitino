...
public class TestGravitinoFlinkConfig {
  ...
  void testCustomClientConfig() {
    ...
    configuration.setString("table.catalog-store.gravitino.gravitino.uri", "http://127.0.0.1:8090");
    configuration.setString(
        "table.catalog-store.gravitino.gravitino.client.config.socketTimeoutMs", "1000");
    configuration.setString(
        "table.catalog-store.gravitino.gravitino.client.config.connectionTimeoutMs", "2000");
