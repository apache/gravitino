...
/** {@link CatalogCompat} implementation for Flink 1.19. */
public enum CatalogCompatFlink119 implements CatalogCompat {
  INSTANCE;

  @Override
  public CatalogTable createCatalogTable(
      Schema schema, String comment, List<String> partitionKeys, Map<String, String> options) {
    // CatalogTable.newBuilder() does not exist yet in Flink 1.19; CatalogTable.of(...) is the
