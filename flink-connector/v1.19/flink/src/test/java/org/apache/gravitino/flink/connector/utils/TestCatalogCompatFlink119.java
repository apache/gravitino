...
public class TestCatalogCompatFlink119 {

  @Test
  public void testCreateCatalogTable() {
    CatalogTable catalogTable =
        CatalogCompatFlink119.INSTANCE.createCatalogTable(
  ...
  public void testSerializeCatalogTable() {
    ...
    Map<String, String> serialized =
        CatalogCompatFlink119.INSTANCE.serializeCatalogTable(resolvedCatalogTable);
  ...
  public void testJdbcDynamicTableFactory() {
    Assertions.assertInstanceOf(
        JdbcDynamicTableFactory.class, CatalogCompatFlink119.INSTANCE.jdbcDynamicTableFactory());
  }
}
