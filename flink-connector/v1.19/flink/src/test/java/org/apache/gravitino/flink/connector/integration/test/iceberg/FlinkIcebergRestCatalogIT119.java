...
// Flink 1.19 uses Iceberg 1.10.x; lakehouse-iceberg (1.11) runs in embedded MiniGravitino in the
// same JVM. Run REST-catalog Iceberg IT in deploy mode only. @DisabledIf is not @Inherited, so
