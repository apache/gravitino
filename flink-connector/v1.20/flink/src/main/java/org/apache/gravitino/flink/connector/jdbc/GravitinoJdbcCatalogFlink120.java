...
/**
 * {@link GravitinoJdbcCatalog} implementation for Flink 1.20. Uses the relocated {@code
 * org.apache.flink.connector.jdbc.core.*} factory packages shipped with {@code flink-connector-jdbc
 * 3.3.x}.
 */
