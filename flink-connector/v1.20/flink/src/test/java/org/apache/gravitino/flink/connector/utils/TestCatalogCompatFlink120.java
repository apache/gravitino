...
public class TestCatalogCompatFlink120 {

  @Test
  public void testCreateCatalogTable() {
    CatalogTable catalogTable =
        CatalogCompatFlink120.INSTANCE.createCatalogTable(
  ...
  public void testSerializeCatalogTable() {
    ...
    Map<String, String> serialized =
        CatalogCompatFlink120.INSTANCE.serializeCatalogTable(resolvedCatalogTable);
  ...
  public void testJdbcDynamicTableFactory() {
    Assertions.assertInstanceOf(
        JdbcDynamicTableFactory.class, CatalogCompatFlink120.INSTANCE.jdbcDynamicTableFactory());
  }
}
