...
public class TestCatalogCompatFlink21 {

  @Test
  public void testCreateCatalogTable() {
    CatalogTable catalogTable =
        CatalogCompatFlink21.INSTANCE.createCatalogTable(
  ...
  public void testSerializeCatalogTable() {
    ...
    Map<String, String> serialized =
        CatalogCompatFlink21.INSTANCE.serializeCatalogTable(resolvedCatalogTable);
  ...
  public void testJdbcDynamicTableFactory() {
    Assertions.assertInstanceOf(
        JdbcDynamicTableFactory.class, CatalogCompatFlink21.INSTANCE.jdbcDynamicTableFactory());
  }
}
