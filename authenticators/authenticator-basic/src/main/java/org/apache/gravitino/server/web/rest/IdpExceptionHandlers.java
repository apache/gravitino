...
public class IdpExceptionHandlers {

  private IdpExceptionHandlers() {}
  ...
  private static class UserExceptionHandler extends BaseExceptionHandler {
    ...
    private static final IdpExceptionHandler INSTANCE = new UserExceptionHandler();
    ...
    @Override
    public Response handle(IdpOperationType op, String user, String parent, Exception e) {
  ...
  private static class GroupExceptionHandler extends BaseExceptionHandler {
    ...
    private static final IdpExceptionHandler INSTANCE = new GroupExceptionHandler();
    ...
    @Override
    public Response handle(IdpOperationType op, String group, String parent, Exception e) {
  ...
  @VisibleForTesting
  static class BaseExceptionHandler extends IdpExceptionHandler {
