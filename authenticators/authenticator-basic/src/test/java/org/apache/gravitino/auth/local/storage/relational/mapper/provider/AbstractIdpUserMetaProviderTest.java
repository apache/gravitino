...
public abstract class AbstractIdpUserMetaProviderTest {
  ...
  @Test
  void testSelectLocalUsers() {
    String normalizedSql =
        renderScript(
            createProvider().selectLocalUsers(Arrays.asList("tom", "jerry")),
            Map.of("userNames", Arrays.asList("tom", "jerry")));
  ...
  @Test
  void testUpdateLocalUserPassword() {
    String normalizedSql =
        createProvider()
  ...
  @Test
  void testTruncateLocalUserMeta() {
