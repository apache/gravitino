...
public class TestResetPasswordRequest {
  ...
  public void testSerDe() throws JsonProcessingException {
    ...
    assertEquals("new_password", deserRequest.getPassword());
  }

  @Test
  public void testValidate() {
    assertDoesNotThrow(() -> new ResetPasswordRequest("new_password").validate());
    assertThrows(IllegalArgumentException.class, () -> new ResetPasswordRequest(" ").validate());
  }
}
