...
public class TestCreateGroupRequest {
  ...
  public void testSerDe() throws JsonProcessingException {
    ...
    assertEquals("test_group", deserRequest.getGroup());
  }

  @Test
  public void testValidate() {
    assertDoesNotThrow(() -> new CreateGroupRequest("test_group").validate());
    assertThrows(IllegalArgumentException.class, () -> new CreateGroupRequest(" ").validate());
  }
}
