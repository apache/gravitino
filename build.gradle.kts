...
allprojects {
  ...
  val setTestEnvironment: (Test) -> Unit = { param ->
    param.doFirst {
      ...
      param.environment("GRAVITINO_CI_HIVE_DOCKER_IMAGE", "unknowntpo/gravitino-ci:hive-ranger-distro-github-ci")
      ...
      param.environment("GRAVITINO_CI_RANGER_DOCKER_IMAGE", "unknowntpo/gravitino-ci:ranger-ranger-distro-github-ci")
