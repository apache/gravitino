...
allprojects {
  ...
  val setTestEnvironment: (Test) -> Unit = { param ->
    param.doFirst {
      ...
      param.environment("GRAVITINO_CI_HIVE_DOCKER_IMAGE", "unknowntpo/gravitino-ci:hive-change-hive-username")
      param.environment("GRAVITINO_CI_KERBEROS_HIVE_DOCKER_IMAGE", "unknowntpo/gravitino-ci:kerberos-hive-change-hive-username")
