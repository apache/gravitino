...
- **Design documents**: Structure from `agent-skills/gravitino-design-doc/SKILL.md`. Formatting from `design-docs/markdown-formatting.md`. Start at `design-docs/README.md`. Run `./gradlew markdownlint`.
