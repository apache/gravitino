...
public class MockIcebergViewRegisterOperations extends IcebergViewRegisterOperations {
  @Inject
  public MockIcebergViewRegisterOperations(IcebergViewOperationDispatcher viewOperationDispatcher) {
