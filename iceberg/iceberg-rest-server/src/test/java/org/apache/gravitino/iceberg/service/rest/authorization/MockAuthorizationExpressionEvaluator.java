...
/** MockAuthorizationExpressionEvaluator for testing authorization in Iceberg REST API. */
public class MockAuthorizationExpressionEvaluator {
  ...
  public MockAuthorizationExpressionEvaluator(String expression) {
    ...
    while (matcher.find()) {
      ...
      String replacement = String.format("authorizer.authorize('%s')", metadataPrivilege);
