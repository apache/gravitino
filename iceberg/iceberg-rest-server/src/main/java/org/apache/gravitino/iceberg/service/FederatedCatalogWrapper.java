...
public class FederatedCatalogWrapper extends CatalogWrapperForREST {
   ...
   * credential and load/create/register requests. Resources are closed in reverse order of
   * creation, and a close failure on one does not prevent the others from being closed.
   *
