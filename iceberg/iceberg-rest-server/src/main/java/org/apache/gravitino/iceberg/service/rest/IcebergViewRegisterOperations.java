...
public class IcebergViewRegisterOperations {

  private static final Logger LOG = LoggerFactory.getLogger(IcebergViewRegisterOperations.class);
  ...
  @Inject
  public IcebergViewRegisterOperations(IcebergViewOperationDispatcher viewOperationDispatcher) {
