...
public class IcebergCreateNamespaceEvent extends IcebergNamespaceEvent {
  ...
  public IcebergCreateNamespaceEvent(
    ...
    this.createNamespaceRequest = IcebergEventUtils.toSerializableMap(createNamespaceRequest);
    this.createNamespaceResponse = IcebergEventUtils.toSerializableMap(createNamespaceResponse);
  }
