...
public class IcebergReplaceViewEvent extends IcebergViewEvent {
  ...
  public IcebergReplaceViewEvent(
    ...
    this.replaceViewRequest = IcebergEventUtils.toSerializableMap(replaceViewRequest);
    this.loadViewResponse = IcebergEventUtils.toSerializableMap(loadViewResponse);
  }
