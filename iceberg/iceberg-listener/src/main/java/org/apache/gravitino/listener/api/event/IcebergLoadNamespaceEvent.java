...
public class IcebergLoadNamespaceEvent extends IcebergNamespaceEvent {
  private final IcebergResponsePayload getNamespaceResponse;

  public IcebergLoadNamespaceEvent(
      IcebergRequestContext icebergRequestContext,
      NameIdentifier nameIdentifier,
      IcebergResponsePayload getNamespaceResponse) {
    super(icebergRequestContext, nameIdentifier);
    this.getNamespaceResponse = getNamespaceResponse;
  }

  public IcebergResponsePayload getNamespaceResponse() {
