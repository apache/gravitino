...
public class IcebergRegisterTableEvent extends IcebergTableEvent {
  ...
  private final IcebergRequestPayload registerTableRequest;
  private final IcebergResponsePayload loadTableResponse;

  public IcebergRegisterTableEvent(
      IcebergRequestContext icebergRequestContext,
      NameIdentifier resourceIdentifier,
      IcebergRequestPayload registerTableRequest,
      IcebergResponsePayload loadTableResponse) {
    super(icebergRequestContext, resourceIdentifier);
    this.registerTableRequest = registerTableRequest;
    this.loadTableResponse = loadTableResponse;
  }

  public IcebergRequestPayload registerTableRequest() {
    return registerTableRequest;
  }

  public IcebergResponsePayload loadTableResponse() {
