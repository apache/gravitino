...
public class IcebergCreateNamespaceEvent extends IcebergNamespaceEvent {
  ...
  private final IcebergRequestPayload createNamespaceRequest;
  private final IcebergResponsePayload createNamespaceResponse;

  public IcebergCreateNamespaceEvent(
      IcebergRequestContext icebergRequestContext,
      NameIdentifier nameIdentifier,
      IcebergRequestPayload createNamespaceRequest,
      IcebergResponsePayload createNamespaceResponse) {
  ...
  public IcebergRequestPayload createNamespaceRequest() {
    return createNamespaceRequest;
  }

  public IcebergResponsePayload createNamespaceResponse() {
