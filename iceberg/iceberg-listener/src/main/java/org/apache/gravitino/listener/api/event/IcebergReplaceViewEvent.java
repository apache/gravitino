...
public class IcebergReplaceViewEvent extends IcebergViewEvent {
  ...
  private final IcebergRequestPayload replaceViewRequest;
  private final IcebergResponsePayload loadViewResponse;

  public IcebergReplaceViewEvent(
      IcebergRequestContext icebergRequestContext,
      NameIdentifier viewIdentifier,
      IcebergRequestPayload replaceViewRequest,
      IcebergResponsePayload loadViewResponse) {
  ...
  public IcebergRequestPayload replaceViewRequest() {
    return replaceViewRequest;
  }

  public IcebergResponsePayload loadViewResponse() {
