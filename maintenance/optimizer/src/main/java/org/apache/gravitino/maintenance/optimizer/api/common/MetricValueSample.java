...
@DeveloperApi
public final class MetricValueSample {

  private final long timestampSeconds;
  private final StatisticValue<?> value;

  public MetricValueSample(long timestampSeconds, StatisticValue<?> value) {
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof MetricValueSample)) {
      return false;
    }
    MetricValueSample other = (MetricValueSample) obj;
  ...
  public String toString() {
    return "MetricValueSample{" + "timestampSeconds=" + timestampSeconds + ", value=" + value + '}';
  }
}
