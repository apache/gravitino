...
public class TestFunctionOperations extends BaseOperationsTest {
  ...
  public void testListFunctions() {
    ...
    // Test mock return null for listFunctions
    when(functionDispatcher.listFunctions(functionNs)).thenReturn(null);
    Response resp1 =
        target(functionPath())
            .request(MediaType.APPLICATION_JSON_TYPE)
            .accept("application/vnd.gravitino.v1+json")
  ...
  private FunctionDefinition[] createMockDefinitions() {
    ...
    FunctionImpl[] impls =
        new FunctionImpl[] {
          FunctionImpl.ofSql(FunctionImpl.RuntimeType.SPARK, "SELECT param1 + 1")
        };
