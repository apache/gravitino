...
import com.datastrato.gravitino.dto.responses.*;
...
import static com.datastrato.gravitino.Configs.*;
...
public class TestUserOperations extends JerseyTest {
    ...
    private User buildUser(String user) {
        return MetalakeUser.builder().withId(1L).withName(user).withProperties(ImmutableMap.of("key", "value"))
                .withAuditInfo(
                        AuditInfo.builder()
                                .withCreator("creator")
