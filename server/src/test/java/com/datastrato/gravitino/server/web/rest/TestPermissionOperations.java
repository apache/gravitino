...
public class TestPermissionOperations extends JerseyTest {
  ...
  public void testGrantRoleToUser() {
    ...
    Response resp =
        target("/metalakes/metalake1/permissions/users/user/roles/")
  ...
  public void testGrantRoleToGroup() {
    ...
    Response resp =
        target("/metalakes/metalake1/permissions/groups/group/roles/")
            .request(MediaType.APPLICATION_JSON_TYPE)
            .accept("application/vnd.gravitino.v1+json")
            .post(Entity.entity(request, MediaType.APPLICATION_JSON_TYPE));
  ...
  public void testRevokeFromUser() {
    ...
    Assertions.assertEquals(Response.Status.OK.getStatusCode(), resp.getStatus());
    RevokeResponse revokeResponse = resp.readEntity(RevokeResponse.class);
    Assertions.assertEquals(0, revokeResponse.getCode());
    Assertions.assertTrue(revokeResponse.revoked());

    // Test when failed to revoke role
    ...
    RevokeResponse revokeResponse2 = resp2.readEntity(RevokeResponse.class);
    Assertions.assertEquals(0, revokeResponse2.getCode());
    Assertions.assertFalse(revokeResponse2.revoked());
