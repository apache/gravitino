...
public class UserOperations {
    ...
    public Response loadUser(
        ...
        try {
            return Utils.ok(new UserResponse(DTOConverters.toDTO(accessControlManager.loadUser(metalake, user))));
        } catch (Exception e) {
    ...
    public Response createUser(
        ...
        try {
            return Utils.ok(new UserResponse(DTOConverters.toDTO(accessControlManager.createUser(metalake, request.getName(), request.getProperties()))));
        } catch (Exception e) {
            return ExceptionHandlers.handleUserException(OperationType.CREATE, request.getName(), metalake, e);
        }
    }
