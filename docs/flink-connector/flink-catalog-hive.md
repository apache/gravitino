...
* Hive metastore 2.x
* HDFS 2.x or 3.x
* Flink 1.19 or 1.20 (the Hive catalog is not supported on Flink 2.x yet — see
...
| Property name in Gravitino catalog properties | Flink Hive connector configuration | Description           |
|-----------------------------------------------|------------------------------------|-----------------------|
| `flink.bypass.default-database`               | `default-database`                 | Hive default database |
| `flink.bypass.hive-conf-dir`                  | `hive-conf-dir`                    | Hive conf dir         |
| `flink.bypass.hive-version`                   | `hive-version`                     | Hive version          |
| `flink.bypass.hadoop-conf-dir`                | `hadoop-conf-dir`                  | Hadoop conf dir       |
