...
| Indexes             | Primary key; data-skipping indexes `DATA_SKIPPING_MINMAX`, `DATA_SKIPPING_BLOOM_FILTER`, and `DATA_SKIPPING_SET` (fixed granularities).                                                                                                                                                                                                                                                                                                                                   |
...
- Data-skipping indexes:
  ...
  - `DATA_SKIPPING_SET` (`GRANULARITY` fixed to 1)
