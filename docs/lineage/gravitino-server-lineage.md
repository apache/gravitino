...
| `gravitino.lineage.queueCapacity`             | The total capacity of lineage event queues. If there are multiple lineage sinks, the lineage sinks use an isolated event queue with the capacity of `gravitino.lineage.queueCapacity` divided by the num of sinks. | 10000                                                  | No       | 0.9.0-incubating |
