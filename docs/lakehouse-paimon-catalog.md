...
| `token-provider`                                   | The token provider type for Aliyun DLF (Data Lake Formation).                                                                                                                                               | Token provider could be `bear` or `dlf`.                                       | required if the value of `catalog-backend` is `rest` and accessing Aliyun DLF Paimon REST server.                                                                    | 1.2.0            |
| `dlf-access-key-id`                                | The access key ID for Aliyun DLF.                                                                                                                                                                           | (none)                                                                         | required if the value of `catalog-backend` is `rest` and accessing Aliyun DLF Paimon REST server.                                                                    | 1.2.0            |
