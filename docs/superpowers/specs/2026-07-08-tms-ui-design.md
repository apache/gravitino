...
The mockups separate metrics into two groups: Decision Metrics determine whether maintenance should run, and Validation Metrics verify whether the completed job improved query speed and table health.
