...
| `gravitino.auxService.iceberg-rest.allowedOrigins`        | A comma separated list of origins that are allowed to access the resources. Default value is *, meaning all origins.                                                                                                                          | `*`                                           | No       | 0.4.0         |
| `gravitino.auxService.iceberg-rest.allowedTimingOrigins`  | A comma separated list of origins that are allowed to time the resource. Default value is the empty string, meaning no origins.                                                                                                               | ``                                            | No       | 0.4.0         |
