...
| `authentication.type`                              | The type of authentication for Iceberg catalog backend, currently we only support `kerberos`, `simple`.                                                                                         | `simple`      | No                                                          | 0.6.0         |
| `authentication.impersonation-enable`              | Whether to enable impersonation for the Hadoop catalog backend.                                                                                                                                 | `false`       | No                                                          | 0.6.0         |
