...
| `fs.gravitino.filesetCatalog.cache.enable`            | Whether to cache the fileset or fileset catalog metadata in the Gravitino Virtual File System. Note that this cache causes a side effect: if you modify the fileset or fileset catalog metadata, the client can not see the latest changes.                                                                          | `false`                                                        | No                                  | 1.0.0            |
...
| `enable_fileset_catalog_cache`  | Whether to cache the fileset or fileset catalog metadata in the Gravitino Virtual File System. Note that this cache causes a side effect: if you modify the fileset or fileset catalog metadata, the client can not see the latest changes.                                                                  | `false`                                                              | No                                | 1.0.0            |
