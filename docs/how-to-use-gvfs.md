...
| `auth_type`                     | The auth type the Gravitino client uses with the Gravitino Virtual File System. Supports `simple` and `oauth2`.                                                                                                                                                                                                                   | `simple`                                                             | No                                | 0.6.0-incubating |
...
Gravitino Virtual File System in Python supports two kinds of authentication types to access Gravitino server: `simple` and `oauth2`.
