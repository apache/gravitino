...
| `client_request_timeout`        | The configuration key for the timeout of the Gravitino client request. You can set the request timeout for the Gravitino client.                                                                                                                                                                             | 10                                                                   | No                                | 1.0.0            |
