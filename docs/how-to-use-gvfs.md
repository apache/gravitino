...
| `fs.gravitino.enableCredentialVending`                | Whether to enable credential vending for the Gravitino Virtual File System.                                                                                                                                                                                                                                                                                            | `false`                                                        | No                                  |
...
| `credential_expiration_ratio`   | The ratio of expiration time for credential from Gravitino. This is used in the cases where Gravitino Fileset catalogs have enable credential vending. if the expiration time of credential fetched from Gravitino is 1 hour, GVFS client will try to refresh the credential in 1 * 0.9 = 0.5 hour.                                                                    | 0.5                                                                  | No                                |
...
| `enable_credential_vending`     | Whether to enable credential vending for the Gravitino Virtual File System.                                                                                                                                                                                                                                                                                            | `false`                                                              | No                                |
