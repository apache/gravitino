...
please create an [issue](https://github.org/apache/gravitino/issues).
...
Hadoop 3. If there's any compatibility issue, please create an [issue](https://github.org/apache/gravitino/issues).
