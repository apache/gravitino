...
|--------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------|----------------------------|------------------|
| `fs.gvfs.filesystem.providers` | The file system providers. Set it to `s3` if it's a s3 fileset or a comma separated string that contains `s3` like `gs,s3` to support multiple kind of fileset including `s3`.                                               | (none)          | Yes                        | 0.7.0-incubating |
...
| Configuration item             | Description                                                                                                                                                                                                                  | Default value   | Required                   | Since version    |
|--------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------|----------------------------|------------------|
| `fs.gvfs.filesystem.providers` | The file system providers. Set it to `gs` if it's a gcs fileset or a comma separated string that contains `gs` like `gs,s3` to support multiple kind of fileset including `gs`.                                              | (none)          | Yes                        | 0.7.0-incubating |
...
| Configuration item             | Description                                                                                                                                                                                                                   | Default value   | Required                   | Since version    |
|--------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------|----------------------------|------------------|
| `fs.gvfs.filesystem.providers` | The file system providers. Set it to `oss` if it's a oss fileset or a comma separated string that contains `oss` like `oss,gs,s3` to support multiple kind of fileset including `oss`.                                        | (none)          | Yes                        | 0.7.0-incubating |
