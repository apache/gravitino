...
| `cos-token`          | COS     | Temporary STS credentials, scoped to the table path        |
...
Gravitino calls Tencent Cloud STS [AssumeRole](https://www.tencentcloud.com/document/product/598/33416) and returns temporary credentials scoped to the table path.
