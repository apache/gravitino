...
| load catalog                | The owner of the metalake, catalog. `LOAD_CATALOG` on the metalake,catalog                                                       |
| create schema               | `CREATE_SCHEMA` on the metalake, catalog or the owner of the metalake, catalog                                                   |
| alter schema                | The owner of the schema, catalog, metalake                                                                                       |
| drop schema                 | The owner of the schema, catalog, metalake                                                                                       |
| list schema                 | The owner of the metalake, catalog can see all the schemas, others can see the schemas which they can load                       |
| load schema                 | The owner of the metalake, catalog, schema. `LOAD_SCHEMA` on the metalake, catalog, schema                                       |
| create table                | `CREATE_TABLE` on the metalake, catalog, schema or the owner of the metalake, catalog, schema                                    |
| alter table                 | The owner of the table, schema,catalog, metalake or `MODIFY_TABLE` on the table, schema, catalog, metalake                       |
| drop table                  | The owner of the table, schema, catalog, metalake                                                                                |
| list table                  | The owner of the schema, catalog, metalake can see all the tables, others can see the table s which they can load                |
| load table                  | The owner of the table, schema, metalake, catalog. `SELECT_TABLE` or `MODIFY_TABLE` on the table, schema, catalog, metalake      |
| create topic                | `CREATE_TOPIC` on the metalake, catalog, schema or the owner of the metalake, catalog, schema                                    |
| alter topic                 | The owner of the topic, schema,catalog, metalake or `PRODUCE_TOPIC` on the topic, schema, catalog, metalake                      |
| drop topic                  | The owner of the topic, schema, catalog, metalake                                                                                |
| list topic                  | The owner of the schema, catalog, metalake can see all the topics, others can see the topics which they can load                 |
| load topic                  | The owner of the topic, schema, metalake, catalog. `CONSUME_TOPIC` or `PRODUCE_TOPIC` on the topic, schema, catalog, metalake    |
| create fileset              | `CREATE_FILESET` on the metalake, catalog, schema or the owner of the metalake, catalog, schema                                  |
| alter fileset               | The owner of the fileset, schema,catalog, metalake or `WRITE_FILESET` on the fileset, schema, catalog, metalake                  |
| drop fileset                | The owner of the fileset, schema, catalog, metalake                                                                              |
| list fileset                | The owner of the schema, catalog, metalake can see all the filesets, others can see the filesets which they can load             |
| load fileset                | The owner of the fileset, schema, metalake, catalog. `READ_FILESET` or `WRITE_FILESET` on the fileset, schema, catalog, metalake |
| register model              | `CREATE_MODEL` on the metalake, catalog, schema or the owner of the metalake, catalog, schema                                    |
| link model version          | `CREATE_MODEL_VERSION` on the metalake, catalog, schema or the owner of the metalake, catalog, schema                            |
| alter model                 | The owner of the model, schema,catalog, metalake                                                                                 |
| drop model                  | The owner of the model, schema, catalog, metalake                                                                                |
| list model                  | The owner of the schema, catalog, metalake can see all the models, others can see the models which they can load                 |
| load model                  | The owner of the model, schema, metalake, catalog. `USE_MODEL on the model, schema, catalog, metalake                            |
| list model version          | The owner of the model, schema, catalog, metalake or `USE_MODEL on the model, schema, catalog, metalake                          |
| load model version          | The owner of the model, schema, metalake, catalog. `USE_MODEL on the model, schema, catalog, metalake                            |
| load model version by alias | The owner of the model, schema, metalake, catalog. `USE_MODEL on the model, schema, catalog, metalake                            |
| delete model version        | The owner of the model, schema, metalake, catalog.                                                                               |
| alter model version         | The owner of the model, schema, metalake, catalog.                                                                               |
| delete model version alias  | The owner of the model, schema, metalake, catalog.                                                                               |
