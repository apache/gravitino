...
| `jdbc.pool.max-size`      | The maximum number of connections in the pool. `10` by default.                                                                                                     | `10`                                                    | No       | 0.5.0         |
| `replication_allocation`  | The number of replications for the table. If not specified and the backend server less than 3, then Gravitino use will the default value `tag.location.default: 1`. | `tag.location.default: 1` if backend server less than 3 | No       | 0.6.0         |
