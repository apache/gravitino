...
| `gravitino.iceberg-rest.catalog-provider-impl`   | The implementation of IcebergTableOpsProvider defines how the Iceberg REST catalog server gets iceberg catalogs.                                                                                                                                                              | `org.apache.gravitino.iceberg.common.ops.ConfigIcebergTableOpsProvider`      | No       | 0.6.0         |
