...
| partitioned_by | Partition columns for the table         | (none)                                                     | No       | 0.4.0         |   
| bucketed_by    | Bucket columns for the table            | (none)                                                     | No       | 0.4.0         |
| bucket_count   | Number of buckets for the table         | (none)                                                     | No       | 0.4.0         |
| sorted_by      | Sorted columns for the table            | (none)                                                     | No       | 0.4.0         |
