...
1. [Download](https://github.org/apache/gravitino/releases) the Gravitino connector tarball and unpack it.
...
```shell
cd /tmp
wget https://github.org/apache/gravitino/releases/gravitino-trino-connector-<version>.tar.gz
