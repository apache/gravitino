...
| `get_list_of_models`                 | Retrieve a list of models within a specific catalog and schema.         | `model`      | 1.0.0         |
...
| `get_list_of_topic`                  | Retrieve a list of topics within a specific catalog and schema.         | `topic`      | 1.0.0         |
| `load_topic`                         | Retrieve comprehensive metadata details for a specific topic.           | `topic`      | 1.0.0         |
| `get_list_of_filesets`               | Retrieve a list of filesets within a specific catalog and schema.       | `fileset`    | 1.0.0         |
...
| `get_list_of_jobs`                   | Retrieve a list of jobs                                                 | `job`        | 1.0.0         |
| `get_job_by_id`                      | Retrieve a job by its ID.                                               | `job`        | 1.0.0         |
| `get_list_of_job_templates`          | Retrieve a list of job templates.                                       | `job`        | 1.0.0         |
...
| `get_list_of_tags`                   | Retrieve a list of tags.                                                | `tag`        | 1.0.0         |
