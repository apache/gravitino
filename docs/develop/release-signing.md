...
This guide explains how to sign and verify Apache Gravitino releases to enhance the security of releases.
A signed release enables people to confirm the author of the release and guarantees
that the code hasn't been altered.
...
1. **How to Install GPG or GnuPG:**
   ...
   [GnuPG](https://www.gnupg.org) is an open-source implementation of the OpenPGP standard
   It allows you to encrypt and sign files or emails.
   ...
   If GPG/GnuPG isn't installed, run the following command to install it.
...
1. **Create a Public/Private Key Pair:**
   ...
   Use this command to generate a public/private key pair. This is a one-time process.
   Setting the key expiry to 5 years and omitting the comment.
   ...
   :::caution important
   Keep your private key secure and saved somewhere other than just on your computer.
   Don't forget your key password, and also securely record it somewhere.
   If you lose your keys or forget your password, you won't be able to sign releases.
   :::
...
1. **Sign a release:**
   ...
   This generates an '.asc' file containing a PGP signature.
   Anyone can use this file and your public signature to verify the release.

1. **Generate hashes for a release:**
...
1. **Copy your public key to the KEYS file:**

   The KEYS file contains public keys used to sign previous releases.
   You only need to do this step once.
   Execute the following command to copy your public key to a KEY file and then append your KEY to the KEYS file.
   The KEYS file contains all the public keys used to sign previous releases.
...
1. **Publish hashes and signatures:**

   Upload the generated '.asc' and '.sha256' files along with the release artifacts
   and KEYS file to the release area.

## Verifying a release

1. **Import public keys:**

   Download the KEYS file. Import the public keys used to sign all previous releases with this command.
   It doesn't matter if you have already imported the keys.
