...
| Gravitino server role operation     | `CreateRolePreEvent`, `DeleteRolePreEvent`, `GetRolePreEvent`, `GrantPrivilegesPreEvent`, `GrantRolesPreEvent`, `ListRoleNamesPreEvent`, `RevokePrivilegesPreEvent`, `RevokeRolesPreEvent`                                                                                                                                | 0.9.0-incubating |
