...
| `gravitino.entity.store.relational`               | Detailed implementation of Relational storage. `MySQL` storage is currently supported, and the implementation is `MySQLBackend`.                                                                                                                 | `MySQLBackend`                   | No       | 0.5.0         |
| `gravitino.entity.store.relational.mysqlUrl`      | The database URL that the `MySQLBackend` needs to connect to.                                                                                                                                                                                    | (none)                           | Yes      | 0.5.0         |
| `gravitino.entity.store.relational.mysqlDriver`   | The jdbc driver name that the `MySQLBackend` needs to use. You should place the driver Jar package in the `${GRAVITINO_HOME}/libs/` directory.                                                                                                   | (none)                           | Yes      | 0.5.0         |
| `gravitino.entity.store.relational.mysqlUser`     | The username that the `MySQLBackend` needs to use when connecting the database.                                                                                                                                                                  | (none)                           | Yes      | 0.5.0         |
| `gravitino.entity.store.relational.mysqlPassword` | The password that the `MySQLBackend` needs to use when connecting the database.                                                                                                                                                                  | (none)                           | Yes      | 0.5.0         |
