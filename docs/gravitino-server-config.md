...
| partition operation                     | `AddPartitionEvent`, `DropPartitionEvent`, `GetPartitionEvent`, `PurgePartitionEvent`, `ListPartitionEvent`, `ListPartitionNamesEvent`, `PartitionExistsEvent`, `AddPartitionFailureEvent`, `DropPartitionFailureEvent`, `GetPartitionFailureEvent`, `PurgePartitionFailureEvent`, `ListPartitionFailureEvent`, `ListPartitionNamesFailureEvent`, `PartitionExistsFailureEvent` | 0.6.0-incubating |
...
| catalog operation                       | `CreateCatalogEvent`, `AlterCatalogEvent`, `DropCatalogEvent`, `LoadCatalogEvent`, `ListCatalogEvent`, `DisableCatalogEvent`, `EnableCatalogEvent`, `CreateCatalogFailureEvent`, `AlterCatalogFailureEvent`, `DropCatalogFailureEvent`, `LoadCatalogFailureEvent`, `ListCatalogFailureEvent`, `DisableCatalogFailureEvent`, `EnableCatalogFailureEvent`                                                                                                                                                                                                                                                                                                                                                                                                                  | 0.5.0            |
| metalake operation                      | `CreateMetalakeEvent`, `AlterMetalakeEvent`, `DropMetalakeEvent`, `LoadMetalakeEvent`, `ListMetalakeEvent`, `DisableMetalakeEvent`, `EnableMetalakeEvent`, `CreateMetalakeFailureEvent`, `AlterMetalakeFailureEvent`, `DropMetalakeFailureEvent`, `LoadMetalakeFailureEvent`, `ListMetalakeFailureEvent`, `DisableMetalakeFailureEvent`, `EnableMetalakeFailureEvent`                                                                                                                                                                                                                                                                                                                                                                                                        | 0.5.0            |
...
| policy operation                        | `CreatePolicyEvent`, `AlterPolicyEvent`, `DeletePolicyEvent`, `GetPolicyEvent`, `ListPoliciesEvent`, `AssociatePoliciesForMetadataObjectEvent`, `ListPolicyInfosEvent`, `GetPolicyForMetadataObjectEvent`, `ListPolicyInfosForMetadataObjectEvent`, `ListMetadataObjectsForPolicyEvent`, `DisablePolicyEvent`, `EnablePolicyEvent`, `CreatePolicyFailureEvent`, `AlterPolicyFailureEvent`, `DeletePolicyFailureEvent`, `GetPolicyFailureEvent`, `ListPoliciesFailureEvent`, `AssociatePoliciesForMetadataObjectFailureEvent`, `ListPolicyInfosFailureEvent`, `GetPolicyForMetadataObjectFailureEvent`, `ListPolicyInfosForMetadataObjectFailureEvent`, `ListMetadataObjectsForPolicyFailureEvent`, `DisablePolicyFailureEvent`, `EnablePolicyFailureEvent` | 1.1.0            |
...
| Gravitino server catalog operation      | `CreateCatalogPreEvent`, `AlterCatalogPreEvent`, `DropCatalogPreEvent`, `LoadCatalogPreEvent`, `ListCatalogPreEvent`, `DisableCatalogPreEvent`, `EnableCatalogPreEvent`                                                                                                                                                                                                       | 0.8.0-incubating |
| Gravitino server metalake operation     | `CreateMetalakePreEvent`, `AlterMetalakePreEvent`,`DropMetalakePreEvent`,`LoadMetalakePreEvent`,`ListMetalakePreEvent`, `DisableMetalakePreEvent`, `EnableMetalakePreEvent`                                                                                                                                                                                                     | 0.8.0-incubating |
...
| Gravitino server topic operation        | `CreateTopicPreEvent`, `AlterTopicPreEvent`, `DropTopicPreEvent`, `LoadTopicPreEvent`, `ListTopicPreEvent`                                                                                                                                                                                                                 | 0.8.0-incubating |
...
| Gravitino server role operation         | `CreateRolePreEvent`, `DeleteRolePreEvent`, `GetRolePreEvent`, `GrantPrivilegesPreEvent`, `RevokePrivilegesPreEvent`, `OverridePrivilegesPreEvent`, `ListRoleNamesPreEvent`                                                                                                                                                                              | 0.9.0-incubating |
...
| policy operation                        | `CreatePolicyPreEvent`, `AlterPolicyPreEvent`, `DeletePolicyPreEvent`, `GetPolicyPreEvent`, `ListPoliciesPreEvent`, `AssociatePoliciesForMetadataObjectPreEvent`, `GetPolicyForMetadataObjectPreEvent`, `ListPolicyInfosForMetadataObjectPreEvent`, `ListMetadataObjectsForPolicyPreEvent`, `ListPolicyInfosPreEvent`, `DisablePolicyPreEvent`, `EnablePolicyPreEvent`                                                                                                                | 1.1.0 |
