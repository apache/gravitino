...
If you use Lance as the partition stats storage, you can set below options

| Configuration item                                 | Description                               | Default value       | Required                                        | Since version |
|----------------------------------------------------|-------------------------------------------|---------------------|-------------------------------------------------|---------------|
| `gravitino.stats.partition.option.location`        | The location of Lance files               | `/tmp`              | No                                              | 1.0.0         |
| `gravitino.stats.partition.option.maxRowsPerFile`  | The max rows per file                     | `1000000`           | No                                              | 1.0.0         |
| `gravitino.stats.partition.option.maxBytesPerFile` | The max bytes per file                    | `100 * 1024 * 1024` | No                                              | 1.0.0         |
| `gravitino.stats.partition.option.maxRowsPerGroup` | The max rows per group                    | `1000000`           | No                                              | 1.0.0         |
| `gravitino.stats.partition.option.readBatchSize`   | The read batch record number when reading | `10000`             | No                                              | 1.0.0         |
