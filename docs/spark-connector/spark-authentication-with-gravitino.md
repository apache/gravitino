...
|------------------------------|--------|---------------|---------------------------------------------------------------------------------------------------------------------|----------|------------------|
| spark.sql.gravitino.authType | string | `simple`      | Authentication mechanisms for Gravitino server; supports `simple`, `basic`, `oauth2`, and `kerberos`. | No       | 0.7.0-incubating |
