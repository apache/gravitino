...
- [`gravitino-azure-bundle-${gravitino-version}.jar`](https://mvnrepository.com/artifact/org.apache.gravitino/gravitino-azure-bundle) is a bundle that
  contains all the dependencies needed to access ADLS. It is recommended to use this JAR when your environment does not include cloud storage dependencies.
  You can use this bundle to access cloud storage through Gravitino directly without downloading extra dependencies.
- [`gravitino-azure-${gravitino-version}.jar`](https://mvnrepository.com/artifact/org.apache.gravitino/gravitino-azure) is a condensed JAR. 
