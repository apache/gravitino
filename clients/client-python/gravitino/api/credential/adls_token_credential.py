...
class ADLSTokenCredential(Credential, ABC):
    ...
    _GRAVITINO_AZURE_STORAGE_ACCOUNT_NAME: str = "azure-storage-account-name"
    _GRAVITINO_ADLS_SAS_TOKEN: str = "adls-sas-token"
    ...
    def __init__(self, credential_info: Dict[str, str], expire_time_in_ms: int):
        ...
        self._sas_token = credential_info[self._GRAVITINO_ADLS_SAS_TOKEN]
    ...
    def credential_info(self) -> Dict[str, str]:
        ...
        """
        return {
            self._GRAVITINO_AZURE_STORAGE_ACCOUNT_NAME: self._account_name,
            self._GRAVITINO_ADLS_SAS_TOKEN: self._sas_token,
        }
