...
class GVFSConfig:
    ...
    # Deprecated: cloud filesets always use credential vending. This key is ignored.
    ...
    # because '_' is used as the separator between prefix, location name, and property name.
