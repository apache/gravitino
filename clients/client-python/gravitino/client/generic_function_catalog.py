...
class FunctionCatalogOperations(FunctionCatalog):
    ...
    def register_function(
        ...
        Args:
            ...
            return_type: The return type (for scalar/aggregate functions).
            return_columns: The return columns (for table-valued functions).
        ...
        # Convert return columns to DTOs if provided
        return_column_dtos = None
        if return_columns:
            return_column_dtos = [
                FunctionColumnDTO.from_function_column(col) for col in return_columns
            ]
        ...
        req = FunctionRegisterRequest(
            ...
            return_columns=return_column_dtos,
        )
        req.validate()
    ...
    def _to_function_update_request(
        ...
        if isinstance(change, UpdateComment):
            ...
            raise IllegalArgumentException(
                f"Unknown function change type: {type(change)}"
            )
