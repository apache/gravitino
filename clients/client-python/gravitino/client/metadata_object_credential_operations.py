...
class MetadataObjectCredentialOperations(SupportsCredentials):
    def __init__(self, metalake_name: str, metadata_object: MetadataObject, rest_client: HTTPClient):
        self._rest_client = rest_client
        self._request_path = "api/metalakes/{}/objects/{}/{}/credentials".format(metalake_name, metadata_object.type().value, metadata_object.name())
        pass
