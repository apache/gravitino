...
class TestGroupDTO(unittest.TestCase):
    ...
    def test_group_dto_methods(self):
        ...
        self.assertIsNotNone(group_dto.audit_info())

    def test_builder_empty_name_raises(self):
        with self.assertRaises(ValueError):
            GroupDTO.builder().with_audit(
    ...
    def test_roles_returns_list_type(self):
        ...
        self.assertIsInstance(group_dto.roles(), list)
    ...
    def test_roles_immutability(self):
        ...
        roles = group_dto.roles()
        roles.append("r3")
        self.assertEqual(["r1", "r2"], group_dto.roles())
