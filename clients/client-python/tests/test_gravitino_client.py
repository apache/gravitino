...
@patch(
    "gravitino.service._Service.get_metalakes",
    return_value=fixtures.services_get_metalakes,
)
@patch(
...
@patch(
    "gravitino.service._Service.get_catalogs",
    return_value=fixtures.services_get_catalogs,
)
@patch(
...
@patch(
    "gravitino.service._Service.get_schemas",
    return_value=fixtures.services_get_schemas,
)
@patch(
...
@patch(
    "gravitino.service._Service.get_tables",
    return_value=fixtures.services_get_tables,
)
@patch(
