...
public class GravitinoVirtualFileSystemS3CredentialIT extends GravitinoVirtualFileSystemIT {
  ...
  public static final String S3_ENDPOINT = "s3.ap-southeast-2.amazonaws.com";
  ...
  public void startUp() throws Exception {
    ...
    properties.put(
        CatalogCredentialManager.CREDENTIAL_TYPES,
    ...
    properties.put(
        ...
        "arn:aws:iam::730335553010:role/access-iceberg-datastrato");
    ...
    conf.set("fs.oss.impl", "org.apache.hadoop.fs.aliyun.oss.AliyunS3FileSystem");
  ...
  @Test
  void testS3SecretKeyCredential() {
    Catalog catalog = metalake.loadCatalog(catalogName);
    Credential[] credentials =
        catalog
            .supportsCredentials()
            .getCredentials(Optional.of(S3SecretKeyCredential.S3_SECRET_KEY_CREDENTIAL_TYPE));
  ...
  void testS3TokenCredential() {
    ...
    Credential[] credentials =
        fileset.supportsCredentials().getCredentials(Optional.of("s3-token"));
    Assertions.assertEquals(1, credentials.length);
