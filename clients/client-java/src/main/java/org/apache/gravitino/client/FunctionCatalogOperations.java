...
class FunctionCatalogOperations implements FunctionCatalog {
  ...
  public Function getFunction(NameIdentifier ident) throws NoSuchFunctionException {
    ...
    return new GenericFunction(resp.getFunction());
  }
  ...
  public Function getFunction(NameIdentifier ident, int version)
    ...
    checkFunctionNameIdentifier(ident);
    Preconditions.checkArgument(version >= 0, "Function version must be >= 0");
  ...
  public Function registerFunction(
    ...
    FunctionRegisterRequest req =
        FunctionRegisterRequest.builder()
            ...
            .definitions(toFunctionDefinitionDTOs(definitions))
            .build();
    req.validate();
  ...
  public Function registerFunction(
    ...
    FunctionRegisterRequest req =
        FunctionRegisterRequest.builder()
            ...
            .deterministic(deterministic)
            .returnColumns(toFunctionColumnDTOs(returnColumns))
            .definitions(toFunctionDefinitionDTOs(definitions))
            .build();
    req.validate();
