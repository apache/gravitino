...
public class TestSupportCredentials extends TestBase {
  ...
  private void testGetCredentials(
    ...
    Credential[] credentials = supportsCredentials.getCredentials(Optional.empty());
    ...
    credentials = supportsCredentials.getCredentials(Optional.empty());
    ...
    Throwable ex =
        Assertions.assertThrows(
            ...
            () -> supportsCredentials.getCredentials(Optional.empty()));
    ...
    Throwable ex1 =
        Assertions.assertThrows(
            RuntimeException.class, () -> supportsCredentials.getCredentials(Optional.empty()));
