...
/**
 * Defines constants for rendering ASCII-art tables, including border characters and their indices.
 * Provides two sets of border characters:
 */
public class OutputConstant {
  public static final char ELLIPSIS = '…';

  public static final ImmutableList<Character> FANCY_ASCII =
      ImmutableList.of(
          '╔', '═', '╤', '╗', '║', '│', '║', '╠', '═', '╪', '╣', '║', '│', '║', '╟', '─', '┼', '╢',
          '╠', '═', '╪', '╣', '║', '│', '║', '╚', '═', '╧', '╝');
