...
/**
 * Pins the Trino 482 SPI shapes of the table-execute delegation in {@link GravitinoMetadata482}:
 ...
 */
class TestTableExecuteDelegation482 {
  ...
  private GravitinoMetadata482 createMetadata(ConnectorMetadata internalMetadata) {
    return new GravitinoMetadata482(
