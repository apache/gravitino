...
public class GravitinoMergeTableHandle
  ...
  /**
   * Constructs a new GravitinoMergeTableHandle from a serialized handle string.
   *
   * @param handleString the serialized handle string
   */
  @JsonCreator
  public GravitinoMergeTableHandle(@JsonProperty(HANDLE_STRING) String handleString) {
   ...
   */
  public GravitinoMergeTableHandle(ConnectorMergeTableHandle mergeTableHandle) {
  ...
  public ConnectorTableHandle getTableHandle() {
    return getInternalHandle().getTableHandle();
  }
}
