...
/** Transforming Apache Gravitino BigQuery metadata to Trino. */
public class BigQueryMetadataAdapter extends CatalogConnectorMetadataAdapter {

  /**
   * Constructs a new BigQueryMetadataAdapter.
   *
   ...
   */
  public BigQueryMetadataAdapter(
