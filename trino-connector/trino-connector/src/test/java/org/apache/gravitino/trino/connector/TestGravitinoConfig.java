  ...
  public void testGravitinoConfigWithClientConfig() {
    ...
    ImmutableMap<String, String> configMapWithClientConfig =
        ImmutableMap.of(
            ...
            "gravitino.client.socketTimeoutMs=10000, gravitino.client.connectionTimeoutMs = 20000 ");
    ...
    ImmutableMap<String, String> configMapWithInvalidClientConfig =
        ImmutableMap.of(
            "gravitino.uri",
            gravitinoUrl,
            "gravitino.metalake",
            metalake,
            "gravitino.client.config",
            "gravitino.client.socketTimeoutMs, gravitino.client.connectionTimeoutMs = 20000 ");
    GravitinoConfig configWithInvalidClientConfig =
        new GravitinoConfig(configMapWithInvalidClientConfig);
    Throwable throwable =
        assertThrows(
            IllegalArgumentException.class, () -> configWithInvalidClientConfig.getClientConfig());
    assertEquals("Invalid client config: gravitino.client.socketTimeoutMs", throwable.getMessage());
  }
}
