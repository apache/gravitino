...
public class GravitinoConnectorFactory453 extends GravitinoConnectorFactory {

  public GravitinoConnectorFactory453(GravitinoAdminClient client) {
    super(client);
  }
  ...
  protected GravitinoConnector createConnector(CatalogConnectorContext connectorContext) {
    return new GravitinoConnector453(connectorContext);
  }

  @Override
  protected GravitinoSystemConnector createSystemConnector(
      GravitinoStoredProcedureFactory storedProcedureFactory) {
    return new GravitinoSystemConnector453(storedProcedureFactory);
  }
}
