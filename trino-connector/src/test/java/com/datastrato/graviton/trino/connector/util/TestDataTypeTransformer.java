...
public class TestDataTypeTransformer {
  ...
  public void testGetGravitonType() {
    ...
    Assertions.assertEquals(
        DataTypeTransformer.getGravitonType(BOOLEAN, true), TypeCreator.NULLABLE.BOOLEAN);
    Assertions.assertEquals(
        DataTypeTransformer.getGravitonType(BOOLEAN, false), TypeCreator.REQUIRED.BOOLEAN);
    ...
    Assertions.assertEquals(
        DataTypeTransformer.getGravitonType(DOUBLE, true), TypeCreator.NULLABLE.FP64);
    Assertions.assertEquals(
        DataTypeTransformer.getGravitonType(DOUBLE, false), TypeCreator.REQUIRED.FP64);

    Assertions.assertEquals(
        DataTypeTransformer.getGravitonType(VARBINARY, true), TypeCreator.NULLABLE.BINARY);
    Assertions.assertEquals(
        DataTypeTransformer.getGravitonType(VARBINARY, false), TypeCreator.REQUIRED.BINARY);
