 ...
 */
public class CatalogRegistrar extends CatalogInjector {
  ...
  private String generateCreateCatalogStatement(
      String catalogName, Map<String, Object> properties) {
  ...
  public Connector createConnector(String connectorName, Map<String, Object> properties) {
    try {
      String stmt = generateCreateCatalogStatement(connectorName, properties);

      final String dbUrl = String.format("jdbc:trino://127.0.0.1:%d", 8080);
      Connection connection = DriverManager.getConnection(dbUrl, "admin", "");
