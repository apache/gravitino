...
public class GravitinoConnectorFactory468 extends GravitinoConnectorFactory {

  public GravitinoConnectorFactory468(GravitinoAdminClient client) {
    super(client);
  }
  ...
  protected GravitinoConnector createConnector(CatalogConnectorContext connectorContext) {
    return new GravitinoConnector468(connectorContext);
  }

  @Override
  protected GravitinoSystemConnector createSystemConnector(
      GravitinoStoredProcedureFactory storedProcedureFactory) {
    return new GravitinoSystemConnector468(storedProcedureFactory);
  }
}
