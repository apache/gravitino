...
public class GravitinoSystemConnector468 extends GravitinoSystemConnector {

  public GravitinoSystemConnector468(
  ...
  public static class Split468 extends Split {

    @JsonCreator
    public Split468(@JsonProperty("tableName") SchemaTableName tableName) {
      super(tableName);
    }
  }
}
