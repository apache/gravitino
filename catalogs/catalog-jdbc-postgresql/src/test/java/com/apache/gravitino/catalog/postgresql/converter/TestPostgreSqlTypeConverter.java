 ...
 * under the License.
 */
package com.apache.gravitino.catalog.postgresql.converter;
...
import static com.apache.gravitino.catalog.postgresql.converter.PostgreSqlTypeConverter.ARRAY_TOKEN;
import static com.apache.gravitino.catalog.postgresql.converter.PostgreSqlTypeConverter.BOOL;
import static com.apache.gravitino.catalog.postgresql.converter.PostgreSqlTypeConverter.BPCHAR;
import static com.apache.gravitino.catalog.postgresql.converter.PostgreSqlTypeConverter.BYTEA;
import static com.apache.gravitino.catalog.postgresql.converter.PostgreSqlTypeConverter.FLOAT_4;
import static com.apache.gravitino.catalog.postgresql.converter.PostgreSqlTypeConverter.FLOAT_8;
import static com.apache.gravitino.catalog.postgresql.converter.PostgreSqlTypeConverter.INT_2;
import static com.apache.gravitino.catalog.postgresql.converter.PostgreSqlTypeConverter.INT_4;
import static com.apache.gravitino.catalog.postgresql.converter.PostgreSqlTypeConverter.INT_8;
import static com.apache.gravitino.catalog.postgresql.converter.PostgreSqlTypeConverter.JDBC_ARRAY_PREFIX;
import static com.apache.gravitino.catalog.postgresql.converter.PostgreSqlTypeConverter.NUMERIC;
...
/**
 * Unit test for {@link com.apache.gravitino.catalog.postgresql.converter.PostgreSqlTypeConverter}.
 */
