...
import static org.apache.gravitino.catalog.maxcompute.converter.MaxComputeTypeConverter.BIGINT;
import static org.apache.gravitino.catalog.maxcompute.converter.MaxComputeTypeConverter.BINARY;
import static org.apache.gravitino.catalog.maxcompute.converter.MaxComputeTypeConverter.BOOLEAN;
import static org.apache.gravitino.catalog.maxcompute.converter.MaxComputeTypeConverter.CHAR;
import static org.apache.gravitino.catalog.maxcompute.converter.MaxComputeTypeConverter.DATETIME;
import static org.apache.gravitino.catalog.maxcompute.converter.MaxComputeTypeConverter.DECIMAL;
import static org.apache.gravitino.catalog.maxcompute.converter.MaxComputeTypeConverter.DOUBLE;
import static org.apache.gravitino.catalog.maxcompute.converter.MaxComputeTypeConverter.FLOAT;
import static org.apache.gravitino.catalog.maxcompute.converter.MaxComputeTypeConverter.INT;
import static org.apache.gravitino.catalog.maxcompute.converter.MaxComputeTypeConverter.STRING;
import static org.apache.gravitino.catalog.maxcompute.converter.MaxComputeTypeConverter.TINYINT;
...
public class TestMaxComputeTypeConverter {
  ...
  public void testToGravitinoType() {
    ...
    checkJdbcTypeToGravitinoType(Types.StringType.get(), STRING, null, null);
    checkJdbcTypeToGravitinoType(Types.BooleanType.get(), BOOLEAN, null, null);
  ...
  public void testFromGravitinoType() {
    ...
    Assertions.assertThrows(
        ...
        () -> MAXCOMPUTE_TYPE_CONVERTER.fromGravitino(Types.UnparsedType.of(USER_DEFINED_TYPE)));
  }

  protected void checkGravitinoTypeToJdbcType(String jdbcTypeName, Type gravitinoType) {
    Assertions.assertEquals(jdbcTypeName, MAXCOMPUTE_TYPE_CONVERTER.fromGravitino(gravitinoType));
  }
  ...
  protected void checkJdbcTypeToGravitinoType(
    ...
    Assertions.assertEquals(gravitinoType, MAXCOMPUTE_TYPE_CONVERTER.toGravitino(typeBean));
  }
