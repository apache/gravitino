...
/**
 * Capability definitions for Hologres catalog.
 *
 * <p>Hologres follows PostgreSQL naming conventions and reserved words with some Hologres-specific
 * restrictions.
 */
public class HologresCatalogCapability implements Capability {
   ...
   * <p>$ - End of the string
   */
  public static final String HOLOGRES_NAME_PATTERN = "^[_a-zA-Z\\p{L}/][\\w\\p{L}-$/=]{0,62}$";

  /**
   * Reserved schema and table names in Hologres that cannot be used for user-defined schemas.
   *
   * <p>Hologres reserves certain schemas for system use, similar to PostgreSQL but with some
   * Hologres-specific additions.
   */
  private static final Set<String> HOLOGRES_RESERVED_WORDS =
      Set.of("pg_catalog", "information_schema", "holo");
  ...
  public CapabilityResult specificationOnName(Scope scope, String name) {
    ...
    if (scope == Scope.SCHEMA && HOLOGRES_RESERVED_WORDS.contains(name.toLowerCase())) {
      return CapabilityResult.unsupported(
