...
public class ModelVersionImpl extends BaseModelVersion {

  public static class Builder extends BaseModelVersionBuilder<Builder, ModelVersionImpl> {

    private Builder() {}

    @Override
    protected ModelVersionImpl internalBuild() {
