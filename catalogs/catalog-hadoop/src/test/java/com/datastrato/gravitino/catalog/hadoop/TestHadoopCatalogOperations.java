...
public class TestHadoopCatalogOperations {
  ...
  public void testLoadSchema() throws IOException {
    ...
    Schema schema = createSchema(name, comment, catalogPath, null);
    NameIdentifier schema16 = NameIdentifier.of("m1", "c1", "schema16");
    ...
    try (HadoopCatalogOperations ops = new HadoopCatalogOperations(store)) {
      ...
      Schema schema1 = ops.loadSchema(NameIdentifier.of("m1", "c1", name));
  ...
  public void testListSchema() throws IOException {
    ...
    try (HadoopCatalogOperations ops = new HadoopCatalogOperations(store)) {
      ...
      Assertions.assertTrue(idents.contains(NameIdentifier.of("m1", "c1", name)));
      Assertions.assertTrue(idents.contains(NameIdentifier.of("m1", "c1", name1)));
    }
  }
  ...
  public void testAlterSchema() throws IOException {
    ...
    try (HadoopCatalogOperations ops = new HadoopCatalogOperations(store)) {
      ...
      Schema schema2 = ops.alterSchema(NameIdentifier.of("m1", "c1", name), setProperty);
      ...
      Schema schema3 = ops.loadSchema(NameIdentifier.of("m1", "c1", name));
      ...
      Schema schema4 = ops.alterSchema(NameIdentifier.of("m1", "c1", name), removeProperty);
      ...
      Schema schema5 = ops.loadSchema(NameIdentifier.of("m1", "c1", name));
  ...
  public void testDropSchema() throws IOException {
    ...
    Schema schema = createSchema(name, comment, catalogPath, null);
    Assertions.assertEquals(name, schema.name());
    NameIdentifier id = NameIdentifier.of("m1", "c1", name);
  ...
  public void testCreateLoadAndDeleteFilesetWithLocations(
    ...
    NameIdentifier schemaIdent = NameIdentifier.of("m1", "c1", schemaName);
    try (HadoopCatalogOperations ops = new HadoopCatalogOperations(store)) {
  ...
  private Schema createSchema(String name, String comment, String catalogPath, String schemaPath)
    ...
    try (HadoopCatalogOperations ops = new HadoopCatalogOperations(store)) {
      ...
      NameIdentifier schemaIdent = NameIdentifier.of("m1", "c1", name);
