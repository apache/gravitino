...
public abstract class CatalogPaimonKerberosBaseIT extends AbstractIT {
  ...
  protected static Map<String, String> catalogProperties;
  protected static final ContainerSuite containerSuite = ContainerSuite.getInstance();
  protected static HiveContainer kerberosHiveContainer;
  protected static MySQLContainer mysqlContainer;
  protected static final String GRAVITINO_CLIENT_PRINCIPAL = "gravitino_client@HADOOPKRB";
  protected static final String GRAVITINO_CLIENT_KEYTAB = "/gravitino_client.keytab";
  protected static final String HDFS_CLIENT_PRINCIPAL = "cli@HADOOPKRB";
  protected static final String HDFS_CLIENT_KEYTAB = "/client.keytab";
  protected static String TMP_DIR;
  protected static GravitinoAdminClient adminClient;
  protected static final String METALAKE_NAME = GravitinoITUtils.genRandomName("test_metalake");
  protected static final String CATALOG_NAME = GravitinoITUtils.genRandomName("test_catalog");
  protected static final String SCHEMA_NAME = GravitinoITUtils.genRandomName("test_schema");
  protected static final String TABLE_NAME = GravitinoITUtils.genRandomName("test_table");
  ...
  protected static Column[] createColumns() {
