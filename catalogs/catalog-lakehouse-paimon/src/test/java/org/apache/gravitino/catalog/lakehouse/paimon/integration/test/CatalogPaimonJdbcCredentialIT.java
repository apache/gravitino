...
/**
 * Integration test for Paimon catalog with JDBC backend credential vending. Tests that JDBC
 * credentials can be retrieved through the credential API.
 */
@Tag("gravitino-docker-test")
public class CatalogPaimonJdbcCredentialIT extends BaseIT {

  private static final Logger LOG = LoggerFactory.getLogger(CatalogPaimonJdbcCredentialIT.class);

  private static final String JDBC_USER = "paimon_user";
  private static final String JDBC_PASSWORD = "paimon_password";

  private String metalakeName = GravitinoITUtils.genRandomName("paimon_jdbc_credential_metalake");
  private String catalogName = GravitinoITUtils.genRandomName("paimon_jdbc_credential_catalog");
  ...
  private void createCatalog() {
    ...
    catalogProperties.put(PaimonCatalogPropertiesMetadata.GRAVITINO_CATALOG_BACKEND, "jdbc");
    catalogProperties.put(PaimonCatalogPropertiesMetadata.URI, "jdbc:sqlite::memory:");
    catalogProperties.put(PaimonCatalogPropertiesMetadata.WAREHOUSE, "/tmp/paimon-jdbc-test");
    catalogProperties.put(PaimonConstants.GRAVITINO_JDBC_DRIVER, "org.sqlite.JDBC");
    catalogProperties.put(PaimonConstants.GRAVITINO_JDBC_USER, JDBC_USER);
    catalogProperties.put(PaimonConstants.GRAVITINO_JDBC_PASSWORD, JDBC_PASSWORD);
