 ...
 */
public class PaimonHiveCachedClientPool implements ClientPool<IMetaStoreClient, TException> {
  ...
  public PaimonHiveCachedClientPool(Configuration conf, Options options, String clientClassName) {
    this.conf = conf;
  ...
  HiveClientPool clientPool() {
    return clientPoolCache.get(key, k -> new HiveClientPool(clientPoolSize, conf, clientClassName));
  }
  ...
  static class ConfElement {
    ...
    public boolean equals(Object obj) {
      ...
      if (obj == null || obj instanceof ConfElement) {
        return false;
      }
