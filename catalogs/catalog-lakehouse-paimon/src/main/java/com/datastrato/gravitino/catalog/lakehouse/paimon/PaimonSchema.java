...
public class PaimonSchema extends BaseSchema {
   ...
   */
  public Pair<String, Map<String, String>> toOriginalPaimonSchema() {
   ...
   */
  public static PaimonSchema fromOriginalPaimonSchema(String name, Map<String, String> properties) {
    return builder()
        .withName(name)
        .withComment(
