...
import com.datastrato.gravitino.catalog.lakehouse.paimon.PaimonCatalogOperations;
...
public class HadoopProxyPlugin implements ProxyPlugin {
  private PaimonCatalogOperations ops;
  ...
  public HadoopProxyPlugin() {
    try {
      ...
      throw new IllegalStateException("Fail to init PaimonCatalogProxyPlugin");
    }
  }
  ...
  public void bindCatalogOperation(CatalogOperations ops) {
    this.ops = ((PaimonCatalogOperations) ops);
