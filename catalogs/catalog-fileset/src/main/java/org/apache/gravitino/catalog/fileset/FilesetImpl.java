...
public class FilesetImpl extends BaseFileset {

  public static class Builder extends BaseFilesetBuilder<Builder, FilesetImpl> {
    /** Creates a new instance of {@link Builder}. */
    private Builder() {}

    @Override
    protected FilesetImpl internalBuild() {
