...
/**
 * InMemoryTableOperations is private in Iceberg InMemoryCatalog implement. 1. make
 * InMemoryTableOperations public 2. add io() to get FileIO 3. add getTables() to get tables to
 * share
 */
public class InMemoryCatalog extends BaseMetastoreCatalog implements SupportsNamespaces, Closeable {
  ...
  protected TableOperations newTableOps(TableIdentifier tableIdentifier) {
    return new InMemoryTableOperations(io, tableIdentifier, tables);
  }
  ...
  ConcurrentMap<TableIdentifier, String> getTables() {
    return tables;
  }
  ...
  public static class InMemoryTableOperations extends BaseMetastoreTableOperations {
    private final FileIO fileIO;
    private final TableIdentifier tableIdentifier;
    private final ConcurrentMap<TableIdentifier, String> tables;

    InMemoryTableOperations(
        FileIO fileIO,
