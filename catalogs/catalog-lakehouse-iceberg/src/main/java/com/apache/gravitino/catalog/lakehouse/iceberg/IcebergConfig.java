...
public class IcebergConfig extends Config implements OverwriteDefaultConfig {
  ...
  public static final ConfigEntry<String> CATALOG_WAREHOUSE =
      new ConfigBuilder(IcebergCatalogPropertiesMetadata.WAREHOUSE)
  ...
  public static final ConfigEntry<String> CATALOG_URI =
      new ConfigBuilder(IcebergCatalogPropertiesMetadata.URI)
  ...
  public static final ConfigEntry<String> JDBC_USER =
      new ConfigBuilder(IcebergCatalogPropertiesMetadata.ICEBERG_JDBC_USER)
  ...
  public static final ConfigEntry<String> JDBC_PASSWORD =
      new ConfigBuilder(IcebergCatalogPropertiesMetadata.ICEBERG_JDBC_PASSWORD)
  ...
  public static final ConfigEntry<String> JDBC_DRIVER =
      new ConfigBuilder(IcebergCatalogPropertiesMetadata.GRAVITINO_JDBC_DRIVER)
  ...
  public static final ConfigEntry<Boolean> JDBC_INIT_TABLES =
      new ConfigBuilder(IcebergCatalogPropertiesMetadata.ICEBERG_JDBC_INITIALIZE)
