...
/** Properties metadata for the Apache Fluss catalog-level configuration. */
public class FlussCatalogPropertiesMetadata extends BaseCatalogPropertiesMetadata {

  // Fluss bootstrap servers to connect to.
