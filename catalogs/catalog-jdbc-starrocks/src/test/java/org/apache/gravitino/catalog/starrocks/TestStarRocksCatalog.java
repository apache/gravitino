...
public class TestStarRocksCatalog {
  ...
  @Test
  void testStarRocksTablePropertiesMetadata() {
    StarRocksTablePropertiesMeta starrocksTablePropertiesMetadata =
        new StarRocksTablePropertiesMeta();
    Map<String, PropertyEntry<?>> propertyEntryMap =
        starrocksTablePropertiesMetadata.specificPropertyEntries();
    ...
    Assertions.assertEquals(
        StarRocksTablePropertiesMeta.DEFAULT_REPLICATION_FACTOR, propertyEntry.getDefaultValue());
