...
dependencies {
  ...
  // However, as the there already exists hadoop2.common in the test classpath, If we added the following
  // dependencies directly, it will cause the conflict between hadoop2 and hadoop3, resulting test
  // failures, so we comment the following line temporarily, if you want to run the test, please uncomment it.
