...
import static com.datastrato.gravitino.catalog.hive.HiveCatalogPropertiesMeta.REFRESH_INTERVAL_SEC;
...
class TestHiveCatalogOperations {
  ...
  void testPropertyMeta() {
    ...
    Assertions.assertFalse(propertyEntryMap.get(REFRESH_INTERVAL_SEC).isRequired());
