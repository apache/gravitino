...
public class HiveCatalogPropertiesMeta extends BaseCatalogPropertiesMetadata {
  ...
  private volatile Map<String, PropertyEntry<?>> hiveCatalogPropertyEntries;
  ...
  protected Map<String, PropertyEntry<?>> specificPropertyEntries() {
    ...
    if (hiveCatalogPropertyEntries == null) {
      synchronized (this) {
        if (hiveCatalogPropertyEntries == null) {
          hiveCatalogPropertyEntries =
    ...
    return hiveCatalogPropertyEntries;
  }
}
